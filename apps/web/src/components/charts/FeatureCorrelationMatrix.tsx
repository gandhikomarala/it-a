...
export const FeatureCorrelationMatrix: React.FC<FeatureCorrelationMatrixProps> = ({
  title = "FeatureCorrelationMatrix",
  data = [
    { x: 0.0, y: 0.0 },
    { x: 0.2, y: 0.55 },
    { x: 0.4, y: 0.78 },
    ...
    <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
      <div className="flex justify-between items-center mb-4 pb-2 border-b border-slate-800">
        <div>
          ...
          <p className="text-xs text-slate-400">Heatmap visualizer displaying pairwise Pearson and Spearman correlation coefficients.</p>
        </div>
      </div>
