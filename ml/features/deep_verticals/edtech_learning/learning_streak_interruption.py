# LearningStreakInterruptionExtractor (EdTech & Corporate Learning SaaS)
# Detects cessation of continuous 7-day study streaks.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class LearningStreakInterruptionExtractor(BaseEstimator, TransformerMixin):
    """LearningStreakInterruptionExtractor: Detects cessation of continuous 7-day study streaks."""
    def __init__(self, prefix: str = "learning_streak_interruption"):
        self.prefix = prefix
        self.params_ = {}
