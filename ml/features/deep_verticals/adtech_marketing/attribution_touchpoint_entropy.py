# AttributionTouchpointEntropyExtractor (AdTech & Growth Marketing SaaS)
# Shannon entropy of multi-touch attribution journey paths.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class AttributionTouchpointEntropyExtractor(BaseEstimator, TransformerMixin):
    """AttributionTouchpointEntropyExtractor: Shannon entropy of multi-touch attribution journey paths."""
    def __init__(self, prefix: str = "attribution_touchpoint_entropy"):
        self.prefix = prefix
        self.params_ = {}
