# CTRDecaySlopeExtractor (AdTech & Growth Marketing SaaS)
# Rate of creative ad fatigue and audience conversion degradation.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class CTRDecaySlopeExtractor(BaseEstimator, TransformerMixin):
    """CTRDecaySlopeExtractor: Rate of creative ad fatigue and audience conversion degradation."""
    def __init__(self, prefix: str = "click_through_rate_decay_slope"):
        self.prefix = prefix
        self.params_ = {}
