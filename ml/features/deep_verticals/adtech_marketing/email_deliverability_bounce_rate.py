# EmailBounceRateExtractor (AdTech & Growth Marketing SaaS)
# Hard and soft bounce rate on outbound automated email flows.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class EmailBounceRateExtractor(BaseEstimator, TransformerMixin):
    """EmailBounceRateExtractor: Hard and soft bounce rate on outbound automated email flows."""
    def __init__(self, prefix: str = "email_deliverability_bounce_rate"):
        self.prefix = prefix
        self.params_ = {}
