# PixelFiringErrorExtractor (AdTech & Growth Marketing SaaS)
# Tracks missing conversion pixels and CAPI server sync errors.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class PixelFiringErrorExtractor(BaseEstimator, TransformerMixin):
    """PixelFiringErrorExtractor: Tracks missing conversion pixels and CAPI server sync errors."""
    def __init__(self, prefix: str = "pixel_tracking_firing_errors"):
        self.prefix = prefix
        self.params_ = {}
