# Computes upper and lower 2-sigma volatility Bollinger Bands around daily usage.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class BollingerBandsUsageTransformer(BaseEstimator, TransformerMixin):
    """BollingerBandsUsageTransformer: Computes upper and lower 2-sigma volatility Bollinger Bands around daily usage."""
    def __init__(self, prefix: str = "bollinger_bands"):
        self.prefix = prefix
        self.params_ = {}
