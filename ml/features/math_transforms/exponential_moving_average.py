# Computes rolling exponential moving average (EMA) smoothing for session hours.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class ExponentialMovingAverageTransformer(BaseEstimator, TransformerMixin):
    """ExponentialMovingAverageTransformer: Computes rolling exponential moving average (EMA) smoothing for session hours."""
    def __init__(self, prefix: str = "exponential_moving_average"):
        self.prefix = prefix
        self.params_ = {}
