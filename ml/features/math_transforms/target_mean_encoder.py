# Smoothed empirical Bayes target encoding for high-cardinality categorical variables.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class TargetMeanEncoderTransformer(BaseEstimator, TransformerMixin):
    """TargetMeanEncoderTransformer: Smoothed empirical Bayes target encoding for high-cardinality categorical variables."""
    def __init__(self, prefix: str = "target_mean_encoder"):
        self.prefix = prefix
        self.params_ = {}
