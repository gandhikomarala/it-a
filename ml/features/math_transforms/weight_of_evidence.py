# Calculates Weight of Evidence (WoE) and Information Value (IV) for risk binning.
...
class WeightOfEvidenceTransformer(BaseEstimator, TransformerMixin):
    """WeightOfEvidenceTransformer: Calculates Weight of Evidence (WoE) and Information Value (IV) for risk binning."""
    def __init__(self, prefix: str = "weight_of_evidence"):
        self.prefix = prefix
        self.params_ = {}
