# Out-of-fold target encoding preventing target leakage in training split.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class LeaveOneOutEncoderTransformer(BaseEstimator, TransformerMixin):
    """LeaveOneOutEncoderTransformer: Out-of-fold target encoding preventing target leakage in training split."""
    def __init__(self, prefix: str = "leave_one_out_encoder"):
        self.prefix = prefix
        self.params_ = {}
