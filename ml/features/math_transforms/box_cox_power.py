# Applies Box-Cox power transform to normalize skewed charge distributions.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class BoxCoxPowerTransformer(BaseEstimator, TransformerMixin):
    """BoxCoxPowerTransformer: Applies Box-Cox power transform to normalize skewed charge distributions."""
    def __init__(self, prefix: str = "box_cox_power"):
        self.prefix = prefix
        self.params_ = {}
