# Calculates 14-period Relative Strength Index (RSI) measuring activity momentum.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class RSIUsageMomentumTransformer(BaseEstimator, TransformerMixin):
    """RSIUsageMomentumTransformer: Calculates 14-period Relative Strength Index (RSI) measuring activity momentum."""
    def __init__(self, prefix: str = "relative_strength_index"):
        self.prefix = prefix
        self.params_ = {}
