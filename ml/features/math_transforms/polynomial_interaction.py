# Computes degree-2 polynomial interaction terms between top predictive features.
...
class PolynomialInteractionTransformer(BaseEstimator, TransformerMixin):
    """PolynomialInteractionTransformer: Computes degree-2 polynomial interaction terms between top predictive features."""
    def __init__(self, prefix: str = "polynomial_interaction"):
        self.prefix = prefix
        self.params_ = {}
