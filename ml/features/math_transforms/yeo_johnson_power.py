# Yeo-Johnson power transform supporting zero and negative usage features.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class YeoJohnsonPowerTransformer(BaseEstimator, TransformerMixin):
    """YeoJohnsonPowerTransformer: Yeo-Johnson power transform supporting zero and negative usage features."""
    def __init__(self, prefix: str = "yeo_johnson_power"):
        self.prefix = prefix
        self.params_ = {}
