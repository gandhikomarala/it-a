# Computes exponential decay rate of session duration over recent active periods.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class SessionDurationDecayExtractor(BaseEstimator, TransformerMixin):
    """SessionDurationDecayExtractor: Computes exponential decay rate of session duration over recent active periods."""
    def __init__(self, prefix: str = "session_duration_decay"):
        self.prefix = prefix
        self.stats_ = {}
