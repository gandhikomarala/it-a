# Flags transitions from active promoter to passive or detractor state.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class NPSPromoterToDetractorExtractor(BaseEstimator, TransformerMixin):
    """NPSPromoterToDetractorExtractor: Flags transitions from active promoter to passive or detractor state."""
    def __init__(self, prefix: str = "nps_promoter_to_detractor"):
        self.prefix = prefix
        self.stats_ = {}
