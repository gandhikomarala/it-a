# Calculates the ratio of licensed paid seats versus 30-day active seats (license waste).
from typing import Optional, List
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class SeatUnderutilizationExtractor(BaseEstimator, TransformerMixin):
    """SeatUnderutilizationExtractor: Calculates the ratio of licensed paid seats versus 30-day active seats (license waste)."""
    def __init__(self, prefix: str = "seat_underutilization"):
        self.prefix = prefix
        self.fitted_params_ = {}
