# Measures the proportion of billed amount covered by promotional coupons.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class DiscountUtilizationPctExtractor(BaseEstimator, TransformerMixin):
    """DiscountUtilizationPctExtractor: Measures the proportion of billed amount covered by promotional coupons."""
    def __init__(self, prefix: str = "discount_utilization_pct"):
        self.prefix = prefix
        self.stats_ = {}
