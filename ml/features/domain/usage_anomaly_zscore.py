# Calculates rolling Z-score anomalies for daily active minutes compared to customer historical baseline.
from typing import Optional, List
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class UsageAnomalyZScoreExtractor(BaseEstimator, TransformerMixin):
    """UsageAnomalyZScoreExtractor: Calculates rolling Z-score anomalies for daily active minutes compared to customer historical baseline."""
    def __init__(self, prefix: str = "usage_anomaly_zscore"):
        self.prefix = prefix
        self.fitted_params_ = {}
