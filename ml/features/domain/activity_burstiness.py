# Quantifies activity burstiness and inter-event time variance for customer logins and exports.
from typing import Optional, List
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class ActivityBurstinessExtractor(BaseEstimator, TransformerMixin):
    """ActivityBurstinessExtractor: Quantifies activity burstiness and inter-event time variance for customer logins and exports."""
    def __init__(self, prefix: str = "activity_burstiness"):
        self.prefix = prefix
        self.fitted_params_ = {}
