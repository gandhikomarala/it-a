# Proportion of active usage occurring on desktop web applications.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class DesktopActiveDaysRatioExtractor(BaseEstimator, TransformerMixin):
    """DesktopActiveDaysRatioExtractor: Proportion of active usage occurring on desktop web applications."""
    def __init__(self, prefix: str = "desktop_active_days_ratio"):
        self.prefix = prefix
        self.stats_ = {}
