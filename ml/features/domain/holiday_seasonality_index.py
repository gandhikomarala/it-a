# Adjusts usage metrics for national holidays and corporate shutdown periods.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class HolidaySeasonalityIndexExtractor(BaseEstimator, TransformerMixin):
    """HolidaySeasonalityIndexExtractor: Adjusts usage metrics for national holidays and corporate shutdown periods."""
    def __init__(self, prefix: str = "holiday_seasonality_index"):
        self.prefix = prefix
        self.stats_ = {}
