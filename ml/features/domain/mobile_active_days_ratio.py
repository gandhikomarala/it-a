# Proportion of active usage occurring on mobile native applications.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class MobileActiveDaysRatioExtractor(BaseEstimator, TransformerMixin):
    """MobileActiveDaysRatioExtractor: Proportion of active usage occurring on mobile native applications."""
    def __init__(self, prefix: str = "mobile_active_days_ratio"):
        self.prefix = prefix
        self.stats_ = {}
