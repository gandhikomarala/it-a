# Calculates remaining calendar days before fixed-term contract termination.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class ContractDaysToExpirationExtractor(BaseEstimator, TransformerMixin):
    """ContractDaysToExpirationExtractor: Calculates remaining calendar days before fixed-term contract termination."""
    def __init__(self, prefix: str = "contract_days_to_expiration"):
        self.prefix = prefix
        self.stats_ = {}
