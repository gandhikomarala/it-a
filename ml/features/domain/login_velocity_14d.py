# Calculates 14-day rolling login frequency momentum relative to 60-day baseline.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class LoginVelocity14dExtractor(BaseEstimator, TransformerMixin):
    """LoginVelocity14dExtractor: Calculates 14-day rolling login frequency momentum relative to 60-day baseline."""
    def __init__(self, prefix: str = "login_velocity_14d"):
        self.prefix = prefix
        self.stats_ = {}
