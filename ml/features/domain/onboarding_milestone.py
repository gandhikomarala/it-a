# Evaluates onboarding completion percentage, time-to-first-value (TTFV), and setup checklist progress.
...
class OnboardingMilestoneExtractor(BaseEstimator, TransformerMixin):
    """OnboardingMilestoneExtractor: Evaluates onboarding completion percentage, time-to-first-value (TTFV), and setup checklist progress."""
    def __init__(self, prefix: str = "onboarding_milestone"):
        self.prefix = prefix
        self.fitted_params_ = {}
