# Calculates days remaining to contract renewal and flags cliff renewal risk windows.
from typing import Optional, List
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class ContractCliffExtractor(BaseEstimator, TransformerMixin):
    """ContractCliffExtractor: Calculates days remaining to contract renewal and flags cliff renewal risk windows."""
    def __init__(self, prefix: str = "contract_cliff"):
        self.prefix = prefix
        self.fitted_params_ = {}
