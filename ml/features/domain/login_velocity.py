# Measures the acceleration and deceleration of user logins over 7d, 14d, and 30d rolling windows.
from typing import Optional, List
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class LoginVelocityExtractor(BaseEstimator, TransformerMixin):
    """LoginVelocityExtractor: Measures the acceleration and deceleration of user logins over 7d, 14d, and 30d rolling windows."""
    def __init__(self, prefix: str = "login_velocity"):
        self.prefix = prefix
        self.fitted_params_ = {}
