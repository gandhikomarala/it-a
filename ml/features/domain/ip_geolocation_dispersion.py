# Calculates geographic dispersion of login IP addresses indicating remote teams.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class IPGeolocationDispersionExtractor(BaseEstimator, TransformerMixin):
    """IPGeolocationDispersionExtractor: Calculates geographic dispersion of login IP addresses indicating remote teams."""
    def __init__(self, prefix: str = "ip_geolocation_dispersion"):
        self.prefix = prefix
        self.stats_ = {}
