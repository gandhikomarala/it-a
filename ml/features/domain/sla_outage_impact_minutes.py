# Sums platform downtime minutes directly impacting customer active business hours.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class SLAOutageImpactMinutesExtractor(BaseEstimator, TransformerMixin):
    """SLAOutageImpactMinutesExtractor: Sums platform downtime minutes directly impacting customer active business hours."""
    def __init__(self, prefix: str = "sla_outage_impact_minutes"):
        self.prefix = prefix
        self.stats_ = {}
