# Counts consecutive low customer satisfaction ratings (CSAT <= 2).
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class CSATNegativeStreakExtractor(BaseEstimator, TransformerMixin):
    """CSATNegativeStreakExtractor: Counts consecutive low customer satisfaction ratings (CSAT <= 2)."""
    def __init__(self, prefix: str = "csat_negative_streak"):
        self.prefix = prefix
        self.stats_ = {}
