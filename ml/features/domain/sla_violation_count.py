# Aggregates platform SLA breaches and outage exposure experienced by the customer.
from typing import Optional, List
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class SLAViolationCountExtractor(BaseEstimator, TransformerMixin):
    """SLAViolationCountExtractor: Aggregates platform SLA breaches and outage exposure experienced by the customer."""
    def __init__(self, prefix: str = "sla_violation_count"):
        self.prefix = prefix
        self.fitted_params_ = {}
