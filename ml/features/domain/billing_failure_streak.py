# Tracks consecutive dunning cycle failures, card expiration proximity, and invoice retry counts.
from typing import Optional, List
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class BillingFailureStreakExtractor(BaseEstimator, TransformerMixin):
    """BillingFailureStreakExtractor: Tracks consecutive dunning cycle failures, card expiration proximity, and invoice retry counts."""
    def __init__(self, prefix: str = "billing_failure_streak"):
        self.prefix = prefix
        self.fitted_params_ = {}
