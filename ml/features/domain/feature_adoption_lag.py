# Measures time delay between new platform feature releases and customer adoption.
from typing import Optional, List
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class FeatureAdoptionLagExtractor(BaseEstimator, TransformerMixin):
    """FeatureAdoptionLagExtractor: Measures time delay between new platform feature releases and customer adoption."""
    def __init__(self, prefix: str = "feature_adoption_lag"):
        self.prefix = prefix
        self.fitted_params_ = {}
