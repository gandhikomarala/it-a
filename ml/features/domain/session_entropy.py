# Computes Shannon entropy across application sessions to detect degradation in user workflow randomness.
from typing import Optional, List
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class SessionEntropyExtractor(BaseEstimator, TransformerMixin):
    """SessionEntropyExtractor: Computes Shannon entropy across application sessions to detect degradation in user workflow randomness."""
    def __init__(self, prefix: str = "session_entropy"):
        self.prefix = prefix
        self.fitted_params_ = {}
