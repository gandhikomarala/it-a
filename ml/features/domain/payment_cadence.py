# Analyzes payment timing variability and late payment frequency relative to billing cycle dates.
from typing import Optional, List
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class PaymentCadenceExtractor(BaseEstimator, TransformerMixin):
    """PaymentCadenceExtractor: Analyzes payment timing variability and late payment frequency relative to billing cycle dates."""
    def __init__(self, prefix: str = "payment_cadence"):
        self.prefix = prefix
        self.fitted_params_ = {}
