# Computes the ratio of administrator administrative logins vs regular user logins.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class AdminActivityRatioExtractor(BaseEstimator, TransformerMixin):
    """AdminActivityRatioExtractor: Computes the ratio of administrator administrative logins vs regular user logins."""
    def __init__(self, prefix: str = "admin_activity_ratio"):
        self.prefix = prefix
        self.stats_ = {}
