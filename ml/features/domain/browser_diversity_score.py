# Counts unique client browser engines accessing customer tenant.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class BrowserDiversityScoreExtractor(BaseEstimator, TransformerMixin):
    """BrowserDiversityScoreExtractor: Counts unique client browser engines accessing customer tenant."""
    def __init__(self, prefix: str = "browser_diversity_score"):
        self.prefix = prefix
        self.stats_ = {}
