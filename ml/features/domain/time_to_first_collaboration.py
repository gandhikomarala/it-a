# Measures onboarding speed: days from signup to first multi-user shared asset.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class TimeToFirstCollaborationExtractor(BaseEstimator, TransformerMixin):
    """TimeToFirstCollaborationExtractor: Measures onboarding speed: days from signup to first multi-user shared asset."""
    def __init__(self, prefix: str = "time_to_first_collaboration"):
        self.prefix = prefix
        self.stats_ = {}
