# Detects team contractions and seat deallocations prior to contract renewal.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class CollaboratorRemovalRateExtractor(BaseEstimator, TransformerMixin):
    """CollaboratorRemovalRateExtractor: Detects team contractions and seat deallocations prior to contract renewal."""
    def __init__(self, prefix: str = "collaborator_removal_rate"):
        self.prefix = prefix
        self.stats_ = {}
