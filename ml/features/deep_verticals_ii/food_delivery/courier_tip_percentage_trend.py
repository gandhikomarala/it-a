# CourierTipPercentageTrendExtractor (Food Delivery & Quick-Service)
# Tracks changes in voluntary delivery driver gratuity percentage.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class CourierTipPercentageTrendExtractor(BaseEstimator, TransformerMixin):
    """CourierTipPercentageTrendExtractor: Tracks changes in voluntary delivery driver gratuity percentage."""
    def __init__(self, prefix: str = "courier_tip_percentage_trend"):
        self.prefix = prefix
        self.meta_ = {}
