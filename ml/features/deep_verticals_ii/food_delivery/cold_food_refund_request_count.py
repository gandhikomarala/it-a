# ColdFoodRefundCountExtractor (Food Delivery & Quick-Service)
# Counts refund requests attributed to prolonged driver delivery transit.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class ColdFoodRefundCountExtractor(BaseEstimator, TransformerMixin):
    """ColdFoodRefundCountExtractor: Counts refund requests attributed to prolonged driver delivery transit."""
    def __init__(self, prefix: str = "cold_food_refund_request_count"):
        self.prefix = prefix
        self.meta_ = {}
