# DietaryPreferenceShiftExtractor (Food Delivery & Quick-Service)
# Detects transitions to vegan, gluten-free, or keto dietary categories.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class DietaryPreferenceShiftExtractor(BaseEstimator, TransformerMixin):
    """DietaryPreferenceShiftExtractor: Detects transitions to vegan, gluten-free, or keto dietary categories."""
    def __init__(self, prefix: str = "dietary_preference_shift_flag"):
        self.prefix = prefix
        self.meta_ = {}
