# CourierRatingVarianceExtractor (Food Delivery & Quick-Service)
# Variance in 5-star ratings assigned to delivery drivers.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class CourierRatingVarianceExtractor(BaseEstimator, TransformerMixin):
    """CourierRatingVarianceExtractor: Variance in 5-star ratings assigned to delivery drivers."""
    def __init__(self, prefix: str = "courier_rating_variance"):
        self.prefix = prefix
        self.meta_ = {}
