# CuisineDiversityEntropyExtractor (Food Delivery & Quick-Service)
# Shannon entropy measuring diversity of restaurant cuisines ordered.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class CuisineDiversityEntropyExtractor(BaseEstimator, TransformerMixin):
    """CuisineDiversityEntropyExtractor: Shannon entropy measuring diversity of restaurant cuisines ordered."""
    def __init__(self, prefix: str = "cuisine_diversity_entropy_score"):
        self.prefix = prefix
        self.meta_ = {}
