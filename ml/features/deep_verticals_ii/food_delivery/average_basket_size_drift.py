# AverageBasketSizeDriftExtractor (Food Delivery & Quick-Service)
# Monitors reduction in gross order value per delivery transaction.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class AverageBasketSizeDriftExtractor(BaseEstimator, TransformerMixin):
    """AverageBasketSizeDriftExtractor: Monitors reduction in gross order value per delivery transaction."""
    def __init__(self, prefix: str = "average_basket_size_drift"):
        self.prefix = prefix
        self.meta_ = {}
