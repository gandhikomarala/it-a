# PromoCodeRelianceIndexExtractor (Food Delivery & Quick-Service)
# Proportion of orders placed strictly with promotional discount codes.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class PromoCodeRelianceIndexExtractor(BaseEstimator, TransformerMixin):
    """PromoCodeRelianceIndexExtractor: Proportion of orders placed strictly with promotional discount codes."""
    def __init__(self, prefix: str = "promo_code_reliance_index"):
        self.prefix = prefix
        self.meta_ = {}
