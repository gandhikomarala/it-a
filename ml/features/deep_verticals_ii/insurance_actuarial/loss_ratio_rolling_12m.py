# LossRatioRolling12mExtractor (Insurance & Actuarial SaaS)
# Calculates rolling 12-month claims paid over cumulative earned premium.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class LossRatioRolling12mExtractor(BaseEstimator, TransformerMixin):
    """LossRatioRolling12mExtractor: Calculates rolling 12-month claims paid over cumulative earned premium."""
    def __init__(self, prefix: str = "loss_ratio_rolling_12m"):
        self.prefix = prefix
        self.meta_ = {}
