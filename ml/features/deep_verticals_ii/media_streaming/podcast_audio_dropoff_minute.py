# PodcastAudioDropoffMinuteExtractor (Media, OTT & Digital Publishing)
# Point in audio podcast where listeners disproportionately disconnect.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class PodcastAudioDropoffMinuteExtractor(BaseEstimator, TransformerMixin):
    """PodcastAudioDropoffMinuteExtractor: Point in audio podcast where listeners disproportionately disconnect."""
    def __init__(self, prefix: str = "podcast_audio_dropoff_minute"):
        self.prefix = prefix
        self.meta_ = {}
