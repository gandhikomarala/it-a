# NewsletterCTORatioExtractor (Media, OTT & Digital Publishing)
# Proportion of opened editorial newsletters resulting in article clicks.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class NewsletterCTORatioExtractor(BaseEstimator, TransformerMixin):
    """NewsletterCTORatioExtractor: Proportion of opened editorial newsletters resulting in article clicks."""
    def __init__(self, prefix: str = "newsletter_click_to_open_ratio"):
        self.prefix = prefix
        self.meta_ = {}
