# AdBlockerDetectionFlagExtractor (Media, OTT & Digital Publishing)
# Flags whether reader has client-side ad blocking software enabled.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class AdBlockerDetectionFlagExtractor(BaseEstimator, TransformerMixin):
    """AdBlockerDetectionFlagExtractor: Flags whether reader has client-side ad blocking software enabled."""
    def __init__(self, prefix: str = "ad_blocker_detection_flag"):
        self.prefix = prefix
        self.meta_ = {}
