# OutageDurationMinutesExtractor (Energy & Smart Utilities)
# Cumulative grid blackout minutes experienced by customer.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class OutageDurationMinutesExtractor(BaseEstimator, TransformerMixin):
    """OutageDurationMinutesExtractor: Cumulative grid blackout minutes experienced by customer."""
    def __init__(self, prefix: str = "outage_duration_minutes_exposure"):
        self.prefix = prefix
        self.meta_ = {}
