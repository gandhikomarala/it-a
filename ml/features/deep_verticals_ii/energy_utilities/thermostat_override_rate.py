# ThermostatOverrideRateExtractor (Energy & Smart Utilities)
# Frequency of overriding utility demand-response smart thermostat setpoints.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class ThermostatOverrideRateExtractor(BaseEstimator, TransformerMixin):
    """ThermostatOverrideRateExtractor: Frequency of overriding utility demand-response smart thermostat setpoints."""
    def __init__(self, prefix: str = "thermostat_override_rate"):
        self.prefix = prefix
        self.meta_ = {}
