# GrantDisbursementPacingExtractor (GovTech & Municipal Services)
# Percentage of allocated federal infrastructure grants disbursed.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class GrantDisbursementPacingExtractor(BaseEstimator, TransformerMixin):
    """GrantDisbursementPacingExtractor: Percentage of allocated federal infrastructure grants disbursed."""
    def __init__(self, prefix: str = "grant_disbursement_pacing_pct"):
        self.prefix = prefix
        self.meta_ = {}
