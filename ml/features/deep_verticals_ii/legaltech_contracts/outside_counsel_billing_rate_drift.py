# OutsideCounselBillingRateDriftExtractor (LegalTech & Contract Intelligence)
# Blended hourly billing rate increases requested by law firms.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class OutsideCounselBillingRateDriftExtractor(BaseEstimator, TransformerMixin):
    """OutsideCounselBillingRateDriftExtractor: Blended hourly billing rate increases requested by law firms."""
    def __init__(self, prefix: str = "outside_counsel_billing_rate_drift"):
        self.prefix = prefix
        self.meta_ = {}
