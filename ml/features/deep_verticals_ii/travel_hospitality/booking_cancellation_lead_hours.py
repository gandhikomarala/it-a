# BookingCancellationLeadHoursExtractor (Travel, Airline & Hospitality)
# Average hours before departure/check-in customer cancels reservation.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class BookingCancellationLeadHoursExtractor(BaseEstimator, TransformerMixin):
    """BookingCancellationLeadHoursExtractor: Average hours before departure/check-in customer cancels reservation."""
    def __init__(self, prefix: str = "booking_cancellation_lead_hours"):
        self.prefix = prefix
        self.meta_ = {}
