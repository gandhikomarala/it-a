# CobrandCardSpendTrendExtractor (Travel, Airline & Hospitality)
# Monthly trend in purchasing activity on co-branded airline credit card.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class CobrandCardSpendTrendExtractor(BaseEstimator, TransformerMixin):
    """CobrandCardSpendTrendExtractor: Monthly trend in purchasing activity on co-branded airline credit card."""
    def __init__(self, prefix: str = "cobrand_credit_card_spend_trend"):
        self.prefix = prefix
        self.meta_ = {}
