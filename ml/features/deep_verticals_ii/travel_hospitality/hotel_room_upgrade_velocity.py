# HotelUpgradeVelocityExtractor (Travel, Airline & Hospitality)
# Frequency of guest accepting paid room upgrade offers at check-in.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class HotelUpgradeVelocityExtractor(BaseEstimator, TransformerMixin):
    """HotelUpgradeVelocityExtractor: Frequency of guest accepting paid room upgrade offers at check-in."""
    def __init__(self, prefix: str = "hotel_room_upgrade_velocity"):
        self.prefix = prefix
        self.meta_ = {}
