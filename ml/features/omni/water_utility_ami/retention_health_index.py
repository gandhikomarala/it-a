# RetentionHealthIndexExtractor_Waterutilityami (Municipal Smart Water AMI Network)
...
class RetentionHealthIndexExtractor_Waterutilityami(BaseEstimator, TransformerMixin):
    """RetentionHealthIndexExtractor_Waterutilityami: Composite multi-factorial health score combining tenure, usage, and revenue."""
    def __init__(self, prefix: str = "retention_health_index_water_utility_ami"):
        self.prefix = prefix
        self.stats_ = {}
