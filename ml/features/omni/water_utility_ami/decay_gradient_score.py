# DecayGradientScoreExtractor_Waterutilityami (Municipal Smart Water AMI Network)
...
class DecayGradientScoreExtractor_Waterutilityami(BaseEstimator, TransformerMixin):
    """DecayGradientScoreExtractor_Waterutilityami: Negative exponential decay coefficient over user interaction events."""
    def __init__(self, prefix: str = "decay_gradient_score_water_utility_ami"):
        self.prefix = prefix
        self.stats_ = {}
