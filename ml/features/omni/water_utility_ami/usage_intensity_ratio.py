# UsageIntensityRatioExtractor_Waterutilityami (Municipal Smart Water AMI Network)
...
class UsageIntensityRatioExtractor_Waterutilityami(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Waterutilityami: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_water_utility_ami"):
        self.prefix = prefix
        self.stats_ = {}
