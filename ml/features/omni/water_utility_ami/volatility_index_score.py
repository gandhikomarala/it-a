# VolatilityIndexScoreExtractor_Waterutilityami (Municipal Smart Water AMI Network)
...
class VolatilityIndexScoreExtractor_Waterutilityami(BaseEstimator, TransformerMixin):
    """VolatilityIndexScoreExtractor_Waterutilityami: Variance in user transaction volume indicating impending dissatisfaction."""
    def __init__(self, prefix: str = "volatility_index_score_water_utility_ami"):
        self.prefix = prefix
        self.stats_ = {}
