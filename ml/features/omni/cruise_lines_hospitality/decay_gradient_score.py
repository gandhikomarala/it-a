# DecayGradientScoreExtractor_Cruiselineshospitality (Cruise Line Passenger Lifetime Value)
...
class DecayGradientScoreExtractor_Cruiselineshospitality(BaseEstimator, TransformerMixin):
    """DecayGradientScoreExtractor_Cruiselineshospitality: Negative exponential decay coefficient over user interaction events."""
    def __init__(self, prefix: str = "decay_gradient_score_cruise_lines_hospitality"):
        self.prefix = prefix
        self.stats_ = {}
