# RetentionHealthIndexExtractor_Cruiselineshospitality (Cruise Line Passenger Lifetime Value)
...
class RetentionHealthIndexExtractor_Cruiselineshospitality(BaseEstimator, TransformerMixin):
    """RetentionHealthIndexExtractor_Cruiselineshospitality: Composite multi-factorial health score combining tenure, usage, and revenue."""
    def __init__(self, prefix: str = "retention_health_index_cruise_lines_hospitality"):
        self.prefix = prefix
        self.stats_ = {}
