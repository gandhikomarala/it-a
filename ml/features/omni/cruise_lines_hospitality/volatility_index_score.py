# VolatilityIndexScoreExtractor_Cruiselineshospitality (Cruise Line Passenger Lifetime Value)
...
class VolatilityIndexScoreExtractor_Cruiselineshospitality(BaseEstimator, TransformerMixin):
    """VolatilityIndexScoreExtractor_Cruiselineshospitality: Variance in user transaction volume indicating impending dissatisfaction."""
    def __init__(self, prefix: str = "volatility_index_score_cruise_lines_hospitality"):
        self.prefix = prefix
        self.stats_ = {}
