# FeatureAdoptionBreadthExtractor_Cruiselineshospitality (Cruise Line Passenger Lifetime Value)
...
class FeatureAdoptionBreadthExtractor_Cruiselineshospitality(BaseEstimator, TransformerMixin):
    """FeatureAdoptionBreadthExtractor_Cruiselineshospitality: Measures adoption across advanced platform capabilities."""
    def __init__(self, prefix: str = "feature_adoption_breadth_cruise_lines_hospitality"):
        self.prefix = prefix
        self.stats_ = {}
