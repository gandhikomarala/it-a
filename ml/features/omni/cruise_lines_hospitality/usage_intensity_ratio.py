# UsageIntensityRatioExtractor_Cruiselineshospitality (Cruise Line Passenger Lifetime Value)
...
class UsageIntensityRatioExtractor_Cruiselineshospitality(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Cruiselineshospitality: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_cruise_lines_hospitality"):
        self.prefix = prefix
        self.stats_ = {}
