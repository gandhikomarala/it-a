# SatisfactionDriftDeltaExtractor_Cruiselineshospitality (Cruise Line Passenger Lifetime Value)
...
class SatisfactionDriftDeltaExtractor_Cruiselineshospitality(BaseEstimator, TransformerMixin):
    """SatisfactionDriftDeltaExtractor_Cruiselineshospitality: Quarter-over-quarter delta in customer CSAT and sentiment telemetry."""
    def __init__(self, prefix: str = "satisfaction_drift_delta_cruise_lines_hospitality"):
        self.prefix = prefix
        self.stats_ = {}
