# EngagementMomentumExtractor_Cruiselineshospitality (Cruise Line Passenger Lifetime Value)
...
class EngagementMomentumExtractor_Cruiselineshospitality(BaseEstimator, TransformerMixin):
    """EngagementMomentumExtractor_Cruiselineshospitality: Rolling non-linear momentum index tracking 30-day activity acceleration."""
    def __init__(self, prefix: str = "engagement_momentum_cruise_lines_hospitality"):
        self.prefix = prefix
        self.stats_ = {}
