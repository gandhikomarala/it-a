# UsageIntensityRatioExtractor_Optometryvision (Optometry & Optical Retail Chain)
...
class UsageIntensityRatioExtractor_Optometryvision(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Optometryvision: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_optometry_vision"):
        self.prefix = prefix
        self.stats_ = {}
