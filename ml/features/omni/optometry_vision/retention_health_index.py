# RetentionHealthIndexExtractor_Optometryvision (Optometry & Optical Retail Chain)
...
class RetentionHealthIndexExtractor_Optometryvision(BaseEstimator, TransformerMixin):
    """RetentionHealthIndexExtractor_Optometryvision: Composite multi-factorial health score combining tenure, usage, and revenue."""
    def __init__(self, prefix: str = "retention_health_index_optometry_vision"):
        self.prefix = prefix
        self.stats_ = {}
