# SatisfactionDriftDeltaExtractor_Miningheavyindustry (Mining & Heavy Equipment IoT)
...
class SatisfactionDriftDeltaExtractor_Miningheavyindustry(BaseEstimator, TransformerMixin):
    """SatisfactionDriftDeltaExtractor_Miningheavyindustry: Quarter-over-quarter delta in customer CSAT and sentiment telemetry."""
    def __init__(self, prefix: str = "satisfaction_drift_delta_mining_heavy_industry"):
        self.prefix = prefix
        self.stats_ = {}
