# UsageIntensityRatioExtractor_Miningheavyindustry (Mining & Heavy Equipment IoT)
...
class UsageIntensityRatioExtractor_Miningheavyindustry(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Miningheavyindustry: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_mining_heavy_industry"):
        self.prefix = prefix
        self.stats_ = {}
