# RetentionHealthIndexExtractor_Miningheavyindustry (Mining & Heavy Equipment IoT)
...
class RetentionHealthIndexExtractor_Miningheavyindustry(BaseEstimator, TransformerMixin):
    """RetentionHealthIndexExtractor_Miningheavyindustry: Composite multi-factorial health score combining tenure, usage, and revenue."""
    def __init__(self, prefix: str = "retention_health_index_mining_heavy_industry"):
        self.prefix = prefix
        self.stats_ = {}
