# FeatureAdoptionBreadthExtractor_Investmentbanking (Investment Banking M&A Deal Pipeline)
...
class FeatureAdoptionBreadthExtractor_Investmentbanking(BaseEstimator, TransformerMixin):
    """FeatureAdoptionBreadthExtractor_Investmentbanking: Measures adoption across advanced platform capabilities."""
    def __init__(self, prefix: str = "feature_adoption_breadth_investment_banking"):
        self.prefix = prefix
        self.stats_ = {}
