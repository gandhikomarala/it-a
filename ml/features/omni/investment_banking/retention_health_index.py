# RetentionHealthIndexExtractor_Investmentbanking (Investment Banking M&A Deal Pipeline)
...
class RetentionHealthIndexExtractor_Investmentbanking(BaseEstimator, TransformerMixin):
    """RetentionHealthIndexExtractor_Investmentbanking: Composite multi-factorial health score combining tenure, usage, and revenue."""
    def __init__(self, prefix: str = "retention_health_index_investment_banking"):
        self.prefix = prefix
        self.stats_ = {}
