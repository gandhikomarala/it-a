# UsageIntensityRatioExtractor_Investmentbanking (Investment Banking M&A Deal Pipeline)
...
class UsageIntensityRatioExtractor_Investmentbanking(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Investmentbanking: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_investment_banking"):
        self.prefix = prefix
        self.stats_ = {}
