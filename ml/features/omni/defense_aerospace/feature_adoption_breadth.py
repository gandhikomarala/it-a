# FeatureAdoptionBreadthExtractor_Defenseaerospace (Defense & Aerospace Telemetry)
...
class FeatureAdoptionBreadthExtractor_Defenseaerospace(BaseEstimator, TransformerMixin):
    """FeatureAdoptionBreadthExtractor_Defenseaerospace: Measures adoption across advanced platform capabilities."""
    def __init__(self, prefix: str = "feature_adoption_breadth_defense_aerospace"):
        self.prefix = prefix
        self.stats_ = {}
