# SatisfactionDriftDeltaExtractor_Defenseaerospace (Defense & Aerospace Telemetry)
...
class SatisfactionDriftDeltaExtractor_Defenseaerospace(BaseEstimator, TransformerMixin):
    """SatisfactionDriftDeltaExtractor_Defenseaerospace: Quarter-over-quarter delta in customer CSAT and sentiment telemetry."""
    def __init__(self, prefix: str = "satisfaction_drift_delta_defense_aerospace"):
        self.prefix = prefix
        self.stats_ = {}
