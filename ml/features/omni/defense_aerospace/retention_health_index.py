# RetentionHealthIndexExtractor_Defenseaerospace (Defense & Aerospace Telemetry)
...
class RetentionHealthIndexExtractor_Defenseaerospace(BaseEstimator, TransformerMixin):
    """RetentionHealthIndexExtractor_Defenseaerospace: Composite multi-factorial health score combining tenure, usage, and revenue."""
    def __init__(self, prefix: str = "retention_health_index_defense_aerospace"):
        self.prefix = prefix
        self.stats_ = {}
