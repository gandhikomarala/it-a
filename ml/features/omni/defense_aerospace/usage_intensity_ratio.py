# UsageIntensityRatioExtractor_Defenseaerospace (Defense & Aerospace Telemetry)
...
class UsageIntensityRatioExtractor_Defenseaerospace(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Defenseaerospace: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_defense_aerospace"):
        self.prefix = prefix
        self.stats_ = {}
