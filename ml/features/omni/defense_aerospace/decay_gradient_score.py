# DecayGradientScoreExtractor_Defenseaerospace (Defense & Aerospace Telemetry)
...
class DecayGradientScoreExtractor_Defenseaerospace(BaseEstimator, TransformerMixin):
    """DecayGradientScoreExtractor_Defenseaerospace: Negative exponential decay coefficient over user interaction events."""
    def __init__(self, prefix: str = "decay_gradient_score_defense_aerospace"):
        self.prefix = prefix
        self.stats_ = {}
