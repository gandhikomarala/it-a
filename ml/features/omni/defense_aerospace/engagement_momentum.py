# EngagementMomentumExtractor_Defenseaerospace (Defense & Aerospace Telemetry)
...
class EngagementMomentumExtractor_Defenseaerospace(BaseEstimator, TransformerMixin):
    """EngagementMomentumExtractor_Defenseaerospace: Rolling non-linear momentum index tracking 30-day activity acceleration."""
    def __init__(self, prefix: str = "engagement_momentum_defense_aerospace"):
        self.prefix = prefix
        self.stats_ = {}
