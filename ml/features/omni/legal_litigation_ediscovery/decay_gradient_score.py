# DecayGradientScoreExtractor_Legallitigationediscovery (Complex Litigation E-Discovery Review)
...
class DecayGradientScoreExtractor_Legallitigationediscovery(BaseEstimator, TransformerMixin):
    """DecayGradientScoreExtractor_Legallitigationediscovery: Negative exponential decay coefficient over user interaction events."""
    def __init__(self, prefix: str = "decay_gradient_score_legal_litigation_ediscovery"):
        self.prefix = prefix
        self.stats_ = {}
