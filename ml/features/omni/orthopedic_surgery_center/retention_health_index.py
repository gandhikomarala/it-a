# RetentionHealthIndexExtractor_Orthopedicsurgerycenter (Ambulatory Surgical Center Operations)
...
class RetentionHealthIndexExtractor_Orthopedicsurgerycenter(BaseEstimator, TransformerMixin):
    """RetentionHealthIndexExtractor_Orthopedicsurgerycenter: Composite multi-factorial health score combining tenure, usage, and revenue."""
    def __init__(self, prefix: str = "retention_health_index_orthopedic_surgery_center"):
        self.prefix = prefix
        self.stats_ = {}
