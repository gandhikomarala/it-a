# UsageIntensityRatioExtractor_Orthopedicsurgerycenter (Ambulatory Surgical Center Operations)
...
class UsageIntensityRatioExtractor_Orthopedicsurgerycenter(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Orthopedicsurgerycenter: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_orthopedic_surgery_center"):
        self.prefix = prefix
        self.stats_ = {}
