# DecayGradientScoreExtractor_Cdnedgestreaming (Global CDN Video Edge Caching)
...
class DecayGradientScoreExtractor_Cdnedgestreaming(BaseEstimator, TransformerMixin):
    """DecayGradientScoreExtractor_Cdnedgestreaming: Negative exponential decay coefficient over user interaction events."""
    def __init__(self, prefix: str = "decay_gradient_score_cdn_edge_streaming"):
        self.prefix = prefix
        self.stats_ = {}
