# UsageIntensityRatioExtractor_Cdnedgestreaming (Global CDN Video Edge Caching)
...
class UsageIntensityRatioExtractor_Cdnedgestreaming(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Cdnedgestreaming: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_cdn_edge_streaming"):
        self.prefix = prefix
        self.stats_ = {}
