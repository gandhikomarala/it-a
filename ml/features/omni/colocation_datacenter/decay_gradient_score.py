# DecayGradientScoreExtractor_Colocationdatacenter (Wholesale Colocation Datacenter Power)
...
class DecayGradientScoreExtractor_Colocationdatacenter(BaseEstimator, TransformerMixin):
    """DecayGradientScoreExtractor_Colocationdatacenter: Negative exponential decay coefficient over user interaction events."""
    def __init__(self, prefix: str = "decay_gradient_score_colocation_datacenter"):
        self.prefix = prefix
        self.stats_ = {}
