# VolatilityIndexScoreExtractor_Colocationdatacenter (Wholesale Colocation Datacenter Power)
...
class VolatilityIndexScoreExtractor_Colocationdatacenter(BaseEstimator, TransformerMixin):
    """VolatilityIndexScoreExtractor_Colocationdatacenter: Variance in user transaction volume indicating impending dissatisfaction."""
    def __init__(self, prefix: str = "volatility_index_score_colocation_datacenter"):
        self.prefix = prefix
        self.stats_ = {}
