# UsageIntensityRatioExtractor_Colocationdatacenter (Wholesale Colocation Datacenter Power)
...
class UsageIntensityRatioExtractor_Colocationdatacenter(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Colocationdatacenter: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_colocation_datacenter"):
        self.prefix = prefix
        self.stats_ = {}
