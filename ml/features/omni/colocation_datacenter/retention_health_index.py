# RetentionHealthIndexExtractor_Colocationdatacenter (Wholesale Colocation Datacenter Power)
...
class RetentionHealthIndexExtractor_Colocationdatacenter(BaseEstimator, TransformerMixin):
    """RetentionHealthIndexExtractor_Colocationdatacenter: Composite multi-factorial health score combining tenure, usage, and revenue."""
    def __init__(self, prefix: str = "retention_health_index_colocation_datacenter"):
        self.prefix = prefix
        self.stats_ = {}
