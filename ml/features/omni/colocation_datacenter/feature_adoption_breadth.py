# FeatureAdoptionBreadthExtractor_Colocationdatacenter (Wholesale Colocation Datacenter Power)
...
class FeatureAdoptionBreadthExtractor_Colocationdatacenter(BaseEstimator, TransformerMixin):
    """FeatureAdoptionBreadthExtractor_Colocationdatacenter: Measures adoption across advanced platform capabilities."""
    def __init__(self, prefix: str = "feature_adoption_breadth_colocation_datacenter"):
        self.prefix = prefix
        self.stats_ = {}
