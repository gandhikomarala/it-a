# DecayGradientScoreExtractor_K12Schooldistrictlms (K-12 School District LMS Analytics)
...
class DecayGradientScoreExtractor_K12Schooldistrictlms(BaseEstimator, TransformerMixin):
    """DecayGradientScoreExtractor_K12Schooldistrictlms: Negative exponential decay coefficient over user interaction events."""
    def __init__(self, prefix: str = "decay_gradient_score_k12_school_district_lms"):
        self.prefix = prefix
        self.stats_ = {}
