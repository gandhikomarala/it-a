# UsageIntensityRatioExtractor_Veterinarypractice (Veterinary Practice Management)
...
class UsageIntensityRatioExtractor_Veterinarypractice(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Veterinarypractice: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_veterinary_practice"):
        self.prefix = prefix
        self.stats_ = {}
