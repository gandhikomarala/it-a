# RetentionHealthIndexExtractor_Veterinarypractice (Veterinary Practice Management)
...
class RetentionHealthIndexExtractor_Veterinarypractice(BaseEstimator, TransformerMixin):
    """RetentionHealthIndexExtractor_Veterinarypractice: Composite multi-factorial health score combining tenure, usage, and revenue."""
    def __init__(self, prefix: str = "retention_health_index_veterinary_practice"):
        self.prefix = prefix
        self.stats_ = {}
