# RetentionHealthIndexExtractor_Musicstreamingroyalties (Music Streaming Artist Royalty Split)
...
class RetentionHealthIndexExtractor_Musicstreamingroyalties(BaseEstimator, TransformerMixin):
    """RetentionHealthIndexExtractor_Musicstreamingroyalties: Composite multi-factorial health score combining tenure, usage, and revenue."""
    def __init__(self, prefix: str = "retention_health_index_music_streaming_royalties"):
        self.prefix = prefix
        self.stats_ = {}
