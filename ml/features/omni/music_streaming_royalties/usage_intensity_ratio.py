# UsageIntensityRatioExtractor_Musicstreamingroyalties (Music Streaming Artist Royalty Split)
...
class UsageIntensityRatioExtractor_Musicstreamingroyalties(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Musicstreamingroyalties: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_music_streaming_royalties"):
        self.prefix = prefix
        self.stats_ = {}
