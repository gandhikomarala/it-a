# DecayGradientScoreExtractor_Musicstreamingroyalties (Music Streaming Artist Royalty Split)
...
class DecayGradientScoreExtractor_Musicstreamingroyalties(BaseEstimator, TransformerMixin):
    """DecayGradientScoreExtractor_Musicstreamingroyalties: Negative exponential decay coefficient over user interaction events."""
    def __init__(self, prefix: str = "decay_gradient_score_music_streaming_royalties"):
        self.prefix = prefix
        self.stats_ = {}
