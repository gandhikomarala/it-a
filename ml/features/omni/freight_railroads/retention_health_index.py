# RetentionHealthIndexExtractor_Freightrailroads (Class I Freight Railroad Logistics)
...
class RetentionHealthIndexExtractor_Freightrailroads(BaseEstimator, TransformerMixin):
    """RetentionHealthIndexExtractor_Freightrailroads: Composite multi-factorial health score combining tenure, usage, and revenue."""
    def __init__(self, prefix: str = "retention_health_index_freight_railroads"):
        self.prefix = prefix
        self.stats_ = {}
