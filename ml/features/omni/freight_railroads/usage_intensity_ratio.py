# UsageIntensityRatioExtractor_Freightrailroads (Class I Freight Railroad Logistics)
...
class UsageIntensityRatioExtractor_Freightrailroads(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Freightrailroads: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_freight_railroads"):
        self.prefix = prefix
        self.stats_ = {}
