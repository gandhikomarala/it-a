# UsageIntensityRatioExtractor_Submarinecabletelecom (Submarine Fiber Cable Capacity)
...
class UsageIntensityRatioExtractor_Submarinecabletelecom(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Submarinecabletelecom: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_submarine_cable_telecom"):
        self.prefix = prefix
        self.stats_ = {}
