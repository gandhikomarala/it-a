# FeatureAdoptionBreadthExtractor_Oilgaspipeline (Oil & Gas Pipeline Integrity)
...
class FeatureAdoptionBreadthExtractor_Oilgaspipeline(BaseEstimator, TransformerMixin):
    """FeatureAdoptionBreadthExtractor_Oilgaspipeline: Measures adoption across advanced platform capabilities."""
    def __init__(self, prefix: str = "feature_adoption_breadth_oil_gas_pipeline"):
        self.prefix = prefix
        self.stats_ = {}
