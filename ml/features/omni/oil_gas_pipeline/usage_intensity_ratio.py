# UsageIntensityRatioExtractor_Oilgaspipeline (Oil & Gas Pipeline Integrity)
...
class UsageIntensityRatioExtractor_Oilgaspipeline(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Oilgaspipeline: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_oil_gas_pipeline"):
        self.prefix = prefix
        self.stats_ = {}
