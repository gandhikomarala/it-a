# RetentionHealthIndexExtractor_Oilgaspipeline (Oil & Gas Pipeline Integrity)
...
class RetentionHealthIndexExtractor_Oilgaspipeline(BaseEstimator, TransformerMixin):
    """RetentionHealthIndexExtractor_Oilgaspipeline: Composite multi-factorial health score combining tenure, usage, and revenue."""
    def __init__(self, prefix: str = "retention_health_index_oil_gas_pipeline"):
        self.prefix = prefix
        self.stats_ = {}
