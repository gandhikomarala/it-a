# UsageIntensityRatioExtractor_Higheredadmissions (University Admissions & Enrollment)
...
class UsageIntensityRatioExtractor_Higheredadmissions(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Higheredadmissions: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_higher_ed_admissions"):
        self.prefix = prefix
        self.stats_ = {}
