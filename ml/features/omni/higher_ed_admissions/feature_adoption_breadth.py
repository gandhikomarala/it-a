# FeatureAdoptionBreadthExtractor_Higheredadmissions (University Admissions & Enrollment)
...
class FeatureAdoptionBreadthExtractor_Higheredadmissions(BaseEstimator, TransformerMixin):
    """FeatureAdoptionBreadthExtractor_Higheredadmissions: Measures adoption across advanced platform capabilities."""
    def __init__(self, prefix: str = "feature_adoption_breadth_higher_ed_admissions"):
        self.prefix = prefix
        self.stats_ = {}
