# DecayGradientScoreExtractor_Higheredadmissions (University Admissions & Enrollment)
...
class DecayGradientScoreExtractor_Higheredadmissions(BaseEstimator, TransformerMixin):
    """DecayGradientScoreExtractor_Higheredadmissions: Negative exponential decay coefficient over user interaction events."""
    def __init__(self, prefix: str = "decay_gradient_score_higher_ed_admissions"):
        self.prefix = prefix
        self.stats_ = {}
