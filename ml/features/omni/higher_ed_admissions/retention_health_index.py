# RetentionHealthIndexExtractor_Higheredadmissions (University Admissions & Enrollment)
...
class RetentionHealthIndexExtractor_Higheredadmissions(BaseEstimator, TransformerMixin):
    """RetentionHealthIndexExtractor_Higheredadmissions: Composite multi-factorial health score combining tenure, usage, and revenue."""
    def __init__(self, prefix: str = "retention_health_index_higher_ed_admissions"):
        self.prefix = prefix
        self.stats_ = {}
