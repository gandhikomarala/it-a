# SatisfactionDriftDeltaExtractor_Restaurantfranchise (QSR Franchise Store Operations)
...
class SatisfactionDriftDeltaExtractor_Restaurantfranchise(BaseEstimator, TransformerMixin):
    """SatisfactionDriftDeltaExtractor_Restaurantfranchise: Quarter-over-quarter delta in customer CSAT and sentiment telemetry."""
    def __init__(self, prefix: str = "satisfaction_drift_delta_restaurant_franchise"):
        self.prefix = prefix
        self.stats_ = {}
