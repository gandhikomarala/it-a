# RetentionHealthIndexExtractor_Restaurantfranchise (QSR Franchise Store Operations)
...
class RetentionHealthIndexExtractor_Restaurantfranchise(BaseEstimator, TransformerMixin):
    """RetentionHealthIndexExtractor_Restaurantfranchise: Composite multi-factorial health score combining tenure, usage, and revenue."""
    def __init__(self, prefix: str = "retention_health_index_restaurant_franchise"):
        self.prefix = prefix
        self.stats_ = {}
