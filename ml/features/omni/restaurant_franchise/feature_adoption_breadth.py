# FeatureAdoptionBreadthExtractor_Restaurantfranchise (QSR Franchise Store Operations)
...
class FeatureAdoptionBreadthExtractor_Restaurantfranchise(BaseEstimator, TransformerMixin):
    """FeatureAdoptionBreadthExtractor_Restaurantfranchise: Measures adoption across advanced platform capabilities."""
    def __init__(self, prefix: str = "feature_adoption_breadth_restaurant_franchise"):
        self.prefix = prefix
        self.stats_ = {}
