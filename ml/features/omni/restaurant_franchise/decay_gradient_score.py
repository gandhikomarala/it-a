# DecayGradientScoreExtractor_Restaurantfranchise (QSR Franchise Store Operations)
...
class DecayGradientScoreExtractor_Restaurantfranchise(BaseEstimator, TransformerMixin):
    """DecayGradientScoreExtractor_Restaurantfranchise: Negative exponential decay coefficient over user interaction events."""
    def __init__(self, prefix: str = "decay_gradient_score_restaurant_franchise"):
        self.prefix = prefix
        self.stats_ = {}
