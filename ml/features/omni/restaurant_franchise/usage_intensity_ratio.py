# UsageIntensityRatioExtractor_Restaurantfranchise (QSR Franchise Store Operations)
...
class UsageIntensityRatioExtractor_Restaurantfranchise(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Restaurantfranchise: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_restaurant_franchise"):
        self.prefix = prefix
        self.stats_ = {}
