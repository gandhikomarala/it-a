# EngagementMomentumExtractor_Legalippatents (Patent Prosecution & IP Portfolio)
...
class EngagementMomentumExtractor_Legalippatents(BaseEstimator, TransformerMixin):
    """EngagementMomentumExtractor_Legalippatents: Rolling non-linear momentum index tracking 30-day activity acceleration."""
    def __init__(self, prefix: str = "engagement_momentum_legal_ip_patents"):
        self.prefix = prefix
        self.stats_ = {}
