# RetentionHealthIndexExtractor_Legalippatents (Patent Prosecution & IP Portfolio)
...
class RetentionHealthIndexExtractor_Legalippatents(BaseEstimator, TransformerMixin):
    """RetentionHealthIndexExtractor_Legalippatents: Composite multi-factorial health score combining tenure, usage, and revenue."""
    def __init__(self, prefix: str = "retention_health_index_legal_ip_patents"):
        self.prefix = prefix
        self.stats_ = {}
