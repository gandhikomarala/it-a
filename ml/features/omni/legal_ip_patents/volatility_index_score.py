# VolatilityIndexScoreExtractor_Legalippatents (Patent Prosecution & IP Portfolio)
...
class VolatilityIndexScoreExtractor_Legalippatents(BaseEstimator, TransformerMixin):
    """VolatilityIndexScoreExtractor_Legalippatents: Variance in user transaction volume indicating impending dissatisfaction."""
    def __init__(self, prefix: str = "volatility_index_score_legal_ip_patents"):
        self.prefix = prefix
        self.stats_ = {}
