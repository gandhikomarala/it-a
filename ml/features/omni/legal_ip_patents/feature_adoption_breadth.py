# FeatureAdoptionBreadthExtractor_Legalippatents (Patent Prosecution & IP Portfolio)
...
class FeatureAdoptionBreadthExtractor_Legalippatents(BaseEstimator, TransformerMixin):
    """FeatureAdoptionBreadthExtractor_Legalippatents: Measures adoption across advanced platform capabilities."""
    def __init__(self, prefix: str = "feature_adoption_breadth_legal_ip_patents"):
        self.prefix = prefix
        self.stats_ = {}
