# SatisfactionDriftDeltaExtractor_Legalippatents (Patent Prosecution & IP Portfolio)
...
class SatisfactionDriftDeltaExtractor_Legalippatents(BaseEstimator, TransformerMixin):
    """SatisfactionDriftDeltaExtractor_Legalippatents: Quarter-over-quarter delta in customer CSAT and sentiment telemetry."""
    def __init__(self, prefix: str = "satisfaction_drift_delta_legal_ip_patents"):
        self.prefix = prefix
        self.stats_ = {}
