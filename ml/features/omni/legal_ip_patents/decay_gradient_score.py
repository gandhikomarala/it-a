# DecayGradientScoreExtractor_Legalippatents (Patent Prosecution & IP Portfolio)
...
class DecayGradientScoreExtractor_Legalippatents(BaseEstimator, TransformerMixin):
    """DecayGradientScoreExtractor_Legalippatents: Negative exponential decay coefficient over user interaction events."""
    def __init__(self, prefix: str = "decay_gradient_score_legal_ip_patents"):
        self.prefix = prefix
        self.stats_ = {}
