# UsageIntensityRatioExtractor_Legalippatents (Patent Prosecution & IP Portfolio)
...
class UsageIntensityRatioExtractor_Legalippatents(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Legalippatents: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_legal_ip_patents"):
        self.prefix = prefix
        self.stats_ = {}
