# ContractRenewalBarrierExtractor_Legalippatents (Patent Prosecution & IP Portfolio)
...
class ContractRenewalBarrierExtractor_Legalippatents(BaseEstimator, TransformerMixin):
    """ContractRenewalBarrierExtractor_Legalippatents: Quantifies renewal friction indicators before expiration milestones."""
    def __init__(self, prefix: str = "contract_renewal_barrier_legal_ip_patents"):
        self.prefix = prefix
        self.stats_ = {}
