# UsageIntensityRatioExtractor_Roboticsfleet (Autonomous Robotics & AMR Fleet Management)
...
class UsageIntensityRatioExtractor_Roboticsfleet(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Roboticsfleet: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_robotics_fleet"):
        self.prefix = prefix
        self.stats_ = {}
