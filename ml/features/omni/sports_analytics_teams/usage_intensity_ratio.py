# UsageIntensityRatioExtractor_Sportsanalyticsteams (Professional Sports Team Athlete Tracking)
...
class UsageIntensityRatioExtractor_Sportsanalyticsteams(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Sportsanalyticsteams: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_sports_analytics_teams"):
        self.prefix = prefix
        self.stats_ = {}
