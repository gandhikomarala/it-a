# UsageIntensityRatioExtractor_Airlinerevenuemgmt (Airline Yield & Revenue Management)
...
class UsageIntensityRatioExtractor_Airlinerevenuemgmt(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Airlinerevenuemgmt: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_airline_revenue_mgmt"):
        self.prefix = prefix
        self.stats_ = {}
