# DecayGradientScoreExtractor_Specialtyretail (Specialty Retail Omnichannel Inventory)
...
class DecayGradientScoreExtractor_Specialtyretail(BaseEstimator, TransformerMixin):
    """DecayGradientScoreExtractor_Specialtyretail: Negative exponential decay coefficient over user interaction events."""
    def __init__(self, prefix: str = "decay_gradient_score_specialty_retail"):
        self.prefix = prefix
        self.stats_ = {}
