# RetentionHealthIndexExtractor_Specialtyretail (Specialty Retail Omnichannel Inventory)
...
class RetentionHealthIndexExtractor_Specialtyretail(BaseEstimator, TransformerMixin):
    """RetentionHealthIndexExtractor_Specialtyretail: Composite multi-factorial health score combining tenure, usage, and revenue."""
    def __init__(self, prefix: str = "retention_health_index_specialty_retail"):
        self.prefix = prefix
        self.stats_ = {}
