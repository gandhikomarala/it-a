# UsageIntensityRatioExtractor_Specialtyretail (Specialty Retail Omnichannel Inventory)
...
class UsageIntensityRatioExtractor_Specialtyretail(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Specialtyretail: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_specialty_retail"):
        self.prefix = prefix
        self.stats_ = {}
