# UsageIntensityRatioExtractor_Mvnocellulartelecom (MVNO Mobile Virtual Network Operator)
...
class UsageIntensityRatioExtractor_Mvnocellulartelecom(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Mvnocellulartelecom: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_mvno_cellular_telecom"):
        self.prefix = prefix
        self.stats_ = {}
