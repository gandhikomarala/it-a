# DecayGradientScoreExtractor_Mvnocellulartelecom (MVNO Mobile Virtual Network Operator)
...
class DecayGradientScoreExtractor_Mvnocellulartelecom(BaseEstimator, TransformerMixin):
    """DecayGradientScoreExtractor_Mvnocellulartelecom: Negative exponential decay coefficient over user interaction events."""
    def __init__(self, prefix: str = "decay_gradient_score_mvno_cellular_telecom"):
        self.prefix = prefix
        self.stats_ = {}
