# UsageIntensityRatioExtractor_Esportstournamentplatform (Esports Tournament & Streaming Platform)
...
class UsageIntensityRatioExtractor_Esportstournamentplatform(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Esportstournamentplatform: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_esports_tournament_platform"):
        self.prefix = prefix
        self.stats_ = {}
