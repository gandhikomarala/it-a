# SatisfactionDriftDeltaExtractor_Cleantechsolarasset (Utility Solar Asset Performance)
...
class SatisfactionDriftDeltaExtractor_Cleantechsolarasset(BaseEstimator, TransformerMixin):
    """SatisfactionDriftDeltaExtractor_Cleantechsolarasset: Quarter-over-quarter delta in customer CSAT and sentiment telemetry."""
    def __init__(self, prefix: str = "satisfaction_drift_delta_cleantech_solar_asset"):
        self.prefix = prefix
        self.stats_ = {}
