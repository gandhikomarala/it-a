# VolatilityIndexScoreExtractor_Cleantechsolarasset (Utility Solar Asset Performance)
...
class VolatilityIndexScoreExtractor_Cleantechsolarasset(BaseEstimator, TransformerMixin):
    """VolatilityIndexScoreExtractor_Cleantechsolarasset: Variance in user transaction volume indicating impending dissatisfaction."""
    def __init__(self, prefix: str = "volatility_index_score_cleantech_solar_asset"):
        self.prefix = prefix
        self.stats_ = {}
