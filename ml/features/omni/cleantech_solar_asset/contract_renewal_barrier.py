# ContractRenewalBarrierExtractor_Cleantechsolarasset (Utility Solar Asset Performance)
...
class ContractRenewalBarrierExtractor_Cleantechsolarasset(BaseEstimator, TransformerMixin):
    """ContractRenewalBarrierExtractor_Cleantechsolarasset: Quantifies renewal friction indicators before expiration milestones."""
    def __init__(self, prefix: str = "contract_renewal_barrier_cleantech_solar_asset"):
        self.prefix = prefix
        self.stats_ = {}
