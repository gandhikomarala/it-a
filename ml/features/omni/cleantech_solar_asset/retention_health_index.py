# RetentionHealthIndexExtractor_Cleantechsolarasset (Utility Solar Asset Performance)
...
class RetentionHealthIndexExtractor_Cleantechsolarasset(BaseEstimator, TransformerMixin):
    """RetentionHealthIndexExtractor_Cleantechsolarasset: Composite multi-factorial health score combining tenure, usage, and revenue."""
    def __init__(self, prefix: str = "retention_health_index_cleantech_solar_asset"):
        self.prefix = prefix
        self.stats_ = {}
