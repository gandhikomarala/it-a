# DecayGradientScoreExtractor_Cleantechsolarasset (Utility Solar Asset Performance)
...
class DecayGradientScoreExtractor_Cleantechsolarasset(BaseEstimator, TransformerMixin):
    """DecayGradientScoreExtractor_Cleantechsolarasset: Negative exponential decay coefficient over user interaction events."""
    def __init__(self, prefix: str = "decay_gradient_score_cleantech_solar_asset"):
        self.prefix = prefix
        self.stats_ = {}
