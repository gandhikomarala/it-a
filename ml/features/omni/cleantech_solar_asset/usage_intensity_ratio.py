# UsageIntensityRatioExtractor_Cleantechsolarasset (Utility Solar Asset Performance)
...
class UsageIntensityRatioExtractor_Cleantechsolarasset(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Cleantechsolarasset: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_cleantech_solar_asset"):
        self.prefix = prefix
        self.stats_ = {}
