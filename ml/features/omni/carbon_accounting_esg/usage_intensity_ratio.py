# UsageIntensityRatioExtractor_Carbonaccountingesg (Enterprise Scope 1-2-3 Carbon Accounting)
...
class UsageIntensityRatioExtractor_Carbonaccountingesg(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Carbonaccountingesg: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_carbon_accounting_esg"):
        self.prefix = prefix
        self.stats_ = {}
