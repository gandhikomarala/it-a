# RetentionHealthIndexExtractor_Carbonaccountingesg (Enterprise Scope 1-2-3 Carbon Accounting)
...
class RetentionHealthIndexExtractor_Carbonaccountingesg(BaseEstimator, TransformerMixin):
    """RetentionHealthIndexExtractor_Carbonaccountingesg: Composite multi-factorial health score combining tenure, usage, and revenue."""
    def __init__(self, prefix: str = "retention_health_index_carbon_accounting_esg"):
        self.prefix = prefix
        self.stats_ = {}
