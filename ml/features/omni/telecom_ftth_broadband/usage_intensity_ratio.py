# UsageIntensityRatioExtractor_Telecomftthbroadband (FTTH Fiber Gigabit Broadband Access)
...
class UsageIntensityRatioExtractor_Telecomftthbroadband(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Telecomftthbroadband: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_telecom_ftth_broadband"):
        self.prefix = prefix
        self.stats_ = {}
