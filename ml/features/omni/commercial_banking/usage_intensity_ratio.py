# UsageIntensityRatioExtractor_Commercialbanking (Commercial Treasury & Syndicated Lending)
...
class UsageIntensityRatioExtractor_Commercialbanking(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Commercialbanking: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_commercial_banking"):
        self.prefix = prefix
        self.stats_ = {}
