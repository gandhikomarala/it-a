# UsageIntensityRatioExtractor_Coldchainpharma (Cold Chain Biopharma Logistics)
...
class UsageIntensityRatioExtractor_Coldchainpharma(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Coldchainpharma: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_cold_chain_pharma"):
        self.prefix = prefix
        self.stats_ = {}
