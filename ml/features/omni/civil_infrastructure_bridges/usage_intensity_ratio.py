# UsageIntensityRatioExtractor_Civilinfrastructurebridges (Civil Infrastructure & Bridge Health)
...
class UsageIntensityRatioExtractor_Civilinfrastructurebridges(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Civilinfrastructurebridges: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_civil_infrastructure_bridges"):
        self.prefix = prefix
        self.stats_ = {}
