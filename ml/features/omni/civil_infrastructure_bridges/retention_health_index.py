# RetentionHealthIndexExtractor_Civilinfrastructurebridges (Civil Infrastructure & Bridge Health)
...
class RetentionHealthIndexExtractor_Civilinfrastructurebridges(BaseEstimator, TransformerMixin):
    """RetentionHealthIndexExtractor_Civilinfrastructurebridges: Composite multi-factorial health score combining tenure, usage, and revenue."""
    def __init__(self, prefix: str = "retention_health_index_civil_infrastructure_bridges"):
        self.prefix = prefix
        self.stats_ = {}
