# RetentionHealthIndexExtractor_Luxuryfashiondirect (Luxury Fashion Direct-to-Consumer)
...
class RetentionHealthIndexExtractor_Luxuryfashiondirect(BaseEstimator, TransformerMixin):
    """RetentionHealthIndexExtractor_Luxuryfashiondirect: Composite multi-factorial health score combining tenure, usage, and revenue."""
    def __init__(self, prefix: str = "retention_health_index_luxury_fashion_direct"):
        self.prefix = prefix
        self.stats_ = {}
