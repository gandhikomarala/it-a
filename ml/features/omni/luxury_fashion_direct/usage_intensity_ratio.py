# UsageIntensityRatioExtractor_Luxuryfashiondirect (Luxury Fashion Direct-to-Consumer)
...
class UsageIntensityRatioExtractor_Luxuryfashiondirect(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Luxuryfashiondirect: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_luxury_fashion_direct"):
        self.prefix = prefix
        self.stats_ = {}
