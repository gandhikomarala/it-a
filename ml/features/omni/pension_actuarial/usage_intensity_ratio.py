# UsageIntensityRatioExtractor_Pensionactuarial (Defined Benefit Pension Fund Actuarial)
...
class UsageIntensityRatioExtractor_Pensionactuarial(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Pensionactuarial: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_pension_actuarial"):
        self.prefix = prefix
        self.stats_ = {}
