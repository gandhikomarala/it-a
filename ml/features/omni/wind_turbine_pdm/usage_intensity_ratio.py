# UsageIntensityRatioExtractor_Windturbinepdm (Offshore Wind Turbine Predictive Maintenance)
...
class UsageIntensityRatioExtractor_Windturbinepdm(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Windturbinepdm: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_wind_turbine_pdm"):
        self.prefix = prefix
        self.stats_ = {}
