# FeatureAdoptionBreadthExtractor_Windturbinepdm (Offshore Wind Turbine Predictive Maintenance)
...
class FeatureAdoptionBreadthExtractor_Windturbinepdm(BaseEstimator, TransformerMixin):
    """FeatureAdoptionBreadthExtractor_Windturbinepdm: Measures adoption across advanced platform capabilities."""
    def __init__(self, prefix: str = "feature_adoption_breadth_wind_turbine_pdm"):
        self.prefix = prefix
        self.stats_ = {}
