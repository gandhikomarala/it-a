# DecayGradientScoreExtractor_Windturbinepdm (Offshore Wind Turbine Predictive Maintenance)
...
class DecayGradientScoreExtractor_Windturbinepdm(BaseEstimator, TransformerMixin):
    """DecayGradientScoreExtractor_Windturbinepdm: Negative exponential decay coefficient over user interaction events."""
    def __init__(self, prefix: str = "decay_gradient_score_wind_turbine_pdm"):
        self.prefix = prefix
        self.stats_ = {}
