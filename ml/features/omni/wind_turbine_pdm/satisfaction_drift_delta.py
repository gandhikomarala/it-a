# SatisfactionDriftDeltaExtractor_Windturbinepdm (Offshore Wind Turbine Predictive Maintenance)
...
class SatisfactionDriftDeltaExtractor_Windturbinepdm(BaseEstimator, TransformerMixin):
    """SatisfactionDriftDeltaExtractor_Windturbinepdm: Quarter-over-quarter delta in customer CSAT and sentiment telemetry."""
    def __init__(self, prefix: str = "satisfaction_drift_delta_wind_turbine_pdm"):
        self.prefix = prefix
        self.stats_ = {}
