# RetentionHealthIndexExtractor_Windturbinepdm (Offshore Wind Turbine Predictive Maintenance)
...
class RetentionHealthIndexExtractor_Windturbinepdm(BaseEstimator, TransformerMixin):
    """RetentionHealthIndexExtractor_Windturbinepdm: Composite multi-factorial health score combining tenure, usage, and revenue."""
    def __init__(self, prefix: str = "retention_health_index_wind_turbine_pdm"):
        self.prefix = prefix
        self.stats_ = {}
