# UsageIntensityRatioExtractor_Batterygridstorage (BESS Utility Battery Energy Storage)
...
class UsageIntensityRatioExtractor_Batterygridstorage(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Batterygridstorage: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_battery_grid_storage"):
        self.prefix = prefix
        self.stats_ = {}
