# RetentionHealthIndexExtractor_Batterygridstorage (BESS Utility Battery Energy Storage)
...
class RetentionHealthIndexExtractor_Batterygridstorage(BaseEstimator, TransformerMixin):
    """RetentionHealthIndexExtractor_Batterygridstorage: Composite multi-factorial health score combining tenure, usage, and revenue."""
    def __init__(self, prefix: str = "retention_health_index_battery_grid_storage"):
        self.prefix = prefix
        self.stats_ = {}
