# DecayGradientScoreExtractor_Batterygridstorage (BESS Utility Battery Energy Storage)
...
class DecayGradientScoreExtractor_Batterygridstorage(BaseEstimator, TransformerMixin):
    """DecayGradientScoreExtractor_Batterygridstorage: Negative exponential decay coefficient over user interaction events."""
    def __init__(self, prefix: str = "decay_gradient_score_battery_grid_storage"):
        self.prefix = prefix
        self.stats_ = {}
