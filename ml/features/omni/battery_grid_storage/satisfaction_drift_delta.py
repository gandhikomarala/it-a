# SatisfactionDriftDeltaExtractor_Batterygridstorage (BESS Utility Battery Energy Storage)
...
class SatisfactionDriftDeltaExtractor_Batterygridstorage(BaseEstimator, TransformerMixin):
    """SatisfactionDriftDeltaExtractor_Batterygridstorage: Quarter-over-quarter delta in customer CSAT and sentiment telemetry."""
    def __init__(self, prefix: str = "satisfaction_drift_delta_battery_grid_storage"):
        self.prefix = prefix
        self.stats_ = {}
