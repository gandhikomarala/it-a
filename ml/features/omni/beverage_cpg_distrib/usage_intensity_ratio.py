# UsageIntensityRatioExtractor_Beveragecpgdistrib (Beverage CPG Direct Store Delivery)
...
class UsageIntensityRatioExtractor_Beveragecpgdistrib(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Beveragecpgdistrib: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_beverage_cpg_distrib"):
        self.prefix = prefix
        self.stats_ = {}
