# DecayGradientScoreExtractor_Beveragecpgdistrib (Beverage CPG Direct Store Delivery)
...
class DecayGradientScoreExtractor_Beveragecpgdistrib(BaseEstimator, TransformerMixin):
    """DecayGradientScoreExtractor_Beveragecpgdistrib: Negative exponential decay coefficient over user interaction events."""
    def __init__(self, prefix: str = "decay_gradient_score_beverage_cpg_distrib"):
        self.prefix = prefix
        self.stats_ = {}
