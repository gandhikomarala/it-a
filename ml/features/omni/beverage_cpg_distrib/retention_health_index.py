# RetentionHealthIndexExtractor_Beveragecpgdistrib (Beverage CPG Direct Store Delivery)
...
class RetentionHealthIndexExtractor_Beveragecpgdistrib(BaseEstimator, TransformerMixin):
    """RetentionHealthIndexExtractor_Beveragecpgdistrib: Composite multi-factorial health score combining tenure, usage, and revenue."""
    def __init__(self, prefix: str = "retention_health_index_beverage_cpg_distrib"):
        self.prefix = prefix
        self.stats_ = {}
