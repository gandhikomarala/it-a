# UsageIntensityRatioExtractor_Behavioralmentalhealth (Behavioral & Mental Health Telehealth)
...
class UsageIntensityRatioExtractor_Behavioralmentalhealth(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Behavioralmentalhealth: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_behavioral_mental_health"):
        self.prefix = prefix
        self.stats_ = {}
