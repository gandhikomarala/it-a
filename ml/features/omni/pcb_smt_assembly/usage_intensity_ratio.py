# UsageIntensityRatioExtractor_Pcbsmtassembly (Surface Mount PCB Assembly Quality)
...
class UsageIntensityRatioExtractor_Pcbsmtassembly(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Pcbsmtassembly: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_pcb_smt_assembly"):
        self.prefix = prefix
        self.stats_ = {}
