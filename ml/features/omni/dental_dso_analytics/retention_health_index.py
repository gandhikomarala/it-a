# RetentionHealthIndexExtractor_Dentaldsoanalytics (Dental DSO Practice Optimization)
...
class RetentionHealthIndexExtractor_Dentaldsoanalytics(BaseEstimator, TransformerMixin):
    """RetentionHealthIndexExtractor_Dentaldsoanalytics: Composite multi-factorial health score combining tenure, usage, and revenue."""
    def __init__(self, prefix: str = "retention_health_index_dental_dso_analytics"):
        self.prefix = prefix
        self.stats_ = {}
