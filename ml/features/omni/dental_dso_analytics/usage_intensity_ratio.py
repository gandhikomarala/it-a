# UsageIntensityRatioExtractor_Dentaldsoanalytics (Dental DSO Practice Optimization)
...
class UsageIntensityRatioExtractor_Dentaldsoanalytics(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Dentaldsoanalytics: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_dental_dso_analytics"):
        self.prefix = prefix
        self.stats_ = {}
