# EngagementMomentumExtractor_Semiconductorfabyield (Semiconductor 3nm Wafer Fab Yield)
...
class EngagementMomentumExtractor_Semiconductorfabyield(BaseEstimator, TransformerMixin):
    """EngagementMomentumExtractor_Semiconductorfabyield: Rolling non-linear momentum index tracking 30-day activity acceleration."""
    def __init__(self, prefix: str = "engagement_momentum_semiconductor_fab_yield"):
        self.prefix = prefix
        self.stats_ = {}
