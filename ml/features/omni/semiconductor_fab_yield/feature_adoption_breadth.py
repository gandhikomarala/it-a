# FeatureAdoptionBreadthExtractor_Semiconductorfabyield (Semiconductor 3nm Wafer Fab Yield)
...
class FeatureAdoptionBreadthExtractor_Semiconductorfabyield(BaseEstimator, TransformerMixin):
    """FeatureAdoptionBreadthExtractor_Semiconductorfabyield: Measures adoption across advanced platform capabilities."""
    def __init__(self, prefix: str = "feature_adoption_breadth_semiconductor_fab_yield"):
        self.prefix = prefix
        self.stats_ = {}
