# RetentionHealthIndexExtractor_Semiconductorfabyield (Semiconductor 3nm Wafer Fab Yield)
...
class RetentionHealthIndexExtractor_Semiconductorfabyield(BaseEstimator, TransformerMixin):
    """RetentionHealthIndexExtractor_Semiconductorfabyield: Composite multi-factorial health score combining tenure, usage, and revenue."""
    def __init__(self, prefix: str = "retention_health_index_semiconductor_fab_yield"):
        self.prefix = prefix
        self.stats_ = {}
