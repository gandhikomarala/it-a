# DecayGradientScoreExtractor_Semiconductorfabyield (Semiconductor 3nm Wafer Fab Yield)
...
class DecayGradientScoreExtractor_Semiconductorfabyield(BaseEstimator, TransformerMixin):
    """DecayGradientScoreExtractor_Semiconductorfabyield: Negative exponential decay coefficient over user interaction events."""
    def __init__(self, prefix: str = "decay_gradient_score_semiconductor_fab_yield"):
        self.prefix = prefix
        self.stats_ = {}
