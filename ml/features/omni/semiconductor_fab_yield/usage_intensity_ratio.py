# UsageIntensityRatioExtractor_Semiconductorfabyield (Semiconductor 3nm Wafer Fab Yield)
...
class UsageIntensityRatioExtractor_Semiconductorfabyield(BaseEstimator, TransformerMixin):
    """UsageIntensityRatioExtractor_Semiconductorfabyield: Ratio of weekly active sessions relative to historical cohort baseline."""
    def __init__(self, prefix: str = "usage_intensity_ratio_semiconductor_fab_yield"):
        self.prefix = prefix
        self.stats_ = {}
