# AnomalyClusteringFactorExtractor_Satellitesyntheticaperture (Spaceborne Synthetic Aperture Radar (SAR))
...
class AnomalyClusteringFactorExtractor_Satellitesyntheticaperture(BaseEstimator, TransformerMixin):
    """AnomalyClusteringFactorExtractor_Satellitesyntheticaperture: Quantifies temporal clustering of multivariate warning signals."""
    def __init__(self, prefix: str = "anomaly_clustering_factor_satellite_synthetic_aperture"):
        self.prefix = prefix
        self.stats_ = {}
