# ResilienceMarginRatioExtractor_Satellitesyntheticaperture (Spaceborne Synthetic Aperture Radar (SAR))
...
class ResilienceMarginRatioExtractor_Satellitesyntheticaperture(BaseEstimator, TransformerMixin):
    """ResilienceMarginRatioExtractor_Satellitesyntheticaperture: Ratio of current operating envelope relative to max physical design limits."""
    def __init__(self, prefix: str = "resilience_margin_ratio_satellite_synthetic_aperture"):
        self.prefix = prefix
        self.stats_ = {}
