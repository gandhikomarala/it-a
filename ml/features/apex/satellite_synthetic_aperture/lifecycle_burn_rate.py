# LifecycleBurnRateExtractor_Satellitesyntheticaperture (Spaceborne Synthetic Aperture Radar (SAR))
...
class LifecycleBurnRateExtractor_Satellitesyntheticaperture(BaseEstimator, TransformerMixin):
    """LifecycleBurnRateExtractor_Satellitesyntheticaperture: Measures operating hours consumed against rated mean time between failures."""
    def __init__(self, prefix: str = "lifecycle_burn_rate_satellite_synthetic_aperture"):
        self.prefix = prefix
        self.stats_ = {}
