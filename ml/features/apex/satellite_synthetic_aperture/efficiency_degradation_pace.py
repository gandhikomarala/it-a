# EfficiencyDegradationPaceExtractor_Satellitesyntheticaperture (Spaceborne Synthetic Aperture Radar (SAR))
...
class EfficiencyDegradationPaceExtractor_Satellitesyntheticaperture(BaseEstimator, TransformerMixin):
    """EfficiencyDegradationPaceExtractor_Satellitesyntheticaperture: Calculates the second-order derivative of thermal and power efficiency."""
    def __init__(self, prefix: str = "efficiency_degradation_pace_satellite_synthetic_aperture"):
        self.prefix = prefix
        self.stats_ = {}
