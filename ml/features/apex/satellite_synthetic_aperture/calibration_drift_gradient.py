# CalibrationDriftGradientExtractor_Satellitesyntheticaperture (Spaceborne Synthetic Aperture Radar (SAR))
...
class CalibrationDriftGradientExtractor_Satellitesyntheticaperture(BaseEstimator, TransformerMixin):
    """CalibrationDriftGradientExtractor_Satellitesyntheticaperture: Detects progressive sensor bias and calibration offset drift."""
    def __init__(self, prefix: str = "calibration_drift_gradient_satellite_synthetic_aperture"):
        self.prefix = prefix
        self.stats_ = {}
