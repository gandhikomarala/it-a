# SystemEntropyScoreExtractor_Satellitesyntheticaperture (Spaceborne Synthetic Aperture Radar (SAR))
...
class SystemEntropyScoreExtractor_Satellitesyntheticaperture(BaseEstimator, TransformerMixin):
    """SystemEntropyScoreExtractor_Satellitesyntheticaperture: Shannon information entropy computed across multi-channel telemetry streams."""
    def __init__(self, prefix: str = "system_entropy_score_satellite_synthetic_aperture"):
        self.prefix = prefix
        self.stats_ = {}
