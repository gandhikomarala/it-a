# TelemetryStabilityIndexExtractor_Satellitesyntheticaperture (Spaceborne Synthetic Aperture Radar (SAR))
...
class TelemetryStabilityIndexExtractor_Satellitesyntheticaperture(BaseEstimator, TransformerMixin):
    """TelemetryStabilityIndexExtractor_Satellitesyntheticaperture: Measures sensor telemetry noise-to-signal ratio and stability."""
    def __init__(self, prefix: str = "telemetry_stability_index_satellite_synthetic_aperture"):
        self.prefix = prefix
        self.stats_ = {}
