# ResilienceMarginRatioExtractor_Desalinationwater (Reverse Osmosis Sea Water Desalination)
...
class ResilienceMarginRatioExtractor_Desalinationwater(BaseEstimator, TransformerMixin):
    """ResilienceMarginRatioExtractor_Desalinationwater: Ratio of current operating envelope relative to max physical design limits."""
    def __init__(self, prefix: str = "resilience_margin_ratio_desalination_water"):
        self.prefix = prefix
        self.stats_ = {}
