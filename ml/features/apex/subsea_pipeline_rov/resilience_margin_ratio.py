# ResilienceMarginRatioExtractor_Subseapipelinerov (Subsea Oil Pipeline & Deepsea ROV)
...
class ResilienceMarginRatioExtractor_Subseapipelinerov(BaseEstimator, TransformerMixin):
    """ResilienceMarginRatioExtractor_Subseapipelinerov: Ratio of current operating envelope relative to max physical design limits."""
    def __init__(self, prefix: str = "resilience_margin_ratio_subsea_pipeline_rov"):
        self.prefix = prefix
        self.stats_ = {}
