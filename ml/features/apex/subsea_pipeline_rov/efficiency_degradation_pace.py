# EfficiencyDegradationPaceExtractor_Subseapipelinerov (Subsea Oil Pipeline & Deepsea ROV)
...
class EfficiencyDegradationPaceExtractor_Subseapipelinerov(BaseEstimator, TransformerMixin):
    """EfficiencyDegradationPaceExtractor_Subseapipelinerov: Calculates the second-order derivative of thermal and power efficiency."""
    def __init__(self, prefix: str = "efficiency_degradation_pace_subsea_pipeline_rov"):
        self.prefix = prefix
        self.stats_ = {}
