# CalibrationDriftGradientExtractor_Subseapipelinerov (Subsea Oil Pipeline & Deepsea ROV)
...
class CalibrationDriftGradientExtractor_Subseapipelinerov(BaseEstimator, TransformerMixin):
    """CalibrationDriftGradientExtractor_Subseapipelinerov: Detects progressive sensor bias and calibration offset drift."""
    def __init__(self, prefix: str = "calibration_drift_gradient_subsea_pipeline_rov"):
        self.prefix = prefix
        self.stats_ = {}
