# AnomalyClusteringFactorExtractor_Subseapipelinerov (Subsea Oil Pipeline & Deepsea ROV)
...
class AnomalyClusteringFactorExtractor_Subseapipelinerov(BaseEstimator, TransformerMixin):
    """AnomalyClusteringFactorExtractor_Subseapipelinerov: Quantifies temporal clustering of multivariate warning signals."""
    def __init__(self, prefix: str = "anomaly_clustering_factor_subsea_pipeline_rov"):
        self.prefix = prefix
        self.stats_ = {}
