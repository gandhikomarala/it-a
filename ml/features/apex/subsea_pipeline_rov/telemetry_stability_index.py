# TelemetryStabilityIndexExtractor_Subseapipelinerov (Subsea Oil Pipeline & Deepsea ROV)
...
class TelemetryStabilityIndexExtractor_Subseapipelinerov(BaseEstimator, TransformerMixin):
    """TelemetryStabilityIndexExtractor_Subseapipelinerov: Measures sensor telemetry noise-to-signal ratio and stability."""
    def __init__(self, prefix: str = "telemetry_stability_index_subsea_pipeline_rov"):
        self.prefix = prefix
        self.stats_ = {}
