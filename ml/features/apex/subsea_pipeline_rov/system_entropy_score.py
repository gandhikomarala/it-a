# SystemEntropyScoreExtractor_Subseapipelinerov (Subsea Oil Pipeline & Deepsea ROV)
...
class SystemEntropyScoreExtractor_Subseapipelinerov(BaseEstimator, TransformerMixin):
    """SystemEntropyScoreExtractor_Subseapipelinerov: Shannon information entropy computed across multi-channel telemetry streams."""
    def __init__(self, prefix: str = "system_entropy_score_subsea_pipeline_rov"):
        self.prefix = prefix
        self.stats_ = {}
