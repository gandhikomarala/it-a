# LifecycleBurnRateExtractor_Subseapipelinerov (Subsea Oil Pipeline & Deepsea ROV)
...
class LifecycleBurnRateExtractor_Subseapipelinerov(BaseEstimator, TransformerMixin):
    """LifecycleBurnRateExtractor_Subseapipelinerov: Measures operating hours consumed against rated mean time between failures."""
    def __init__(self, prefix: str = "lifecycle_burn_rate_subsea_pipeline_rov"):
        self.prefix = prefix
        self.stats_ = {}
