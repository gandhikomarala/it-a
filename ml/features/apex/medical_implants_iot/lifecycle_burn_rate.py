# LifecycleBurnRateExtractor_Medicalimplantsiot (Connected Medical Implants & Bio-Telemetry)
...
class LifecycleBurnRateExtractor_Medicalimplantsiot(BaseEstimator, TransformerMixin):
    """LifecycleBurnRateExtractor_Medicalimplantsiot: Measures operating hours consumed against rated mean time between failures."""
    def __init__(self, prefix: str = "lifecycle_burn_rate_medical_implants_iot"):
        self.prefix = prefix
        self.stats_ = {}
