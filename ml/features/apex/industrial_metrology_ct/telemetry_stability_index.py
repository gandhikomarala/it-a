# TelemetryStabilityIndexExtractor_Industrialmetrologyct (Industrial X-Ray Computed Tomography)
...
class TelemetryStabilityIndexExtractor_Industrialmetrologyct(BaseEstimator, TransformerMixin):
    """TelemetryStabilityIndexExtractor_Industrialmetrologyct: Measures sensor telemetry noise-to-signal ratio and stability."""
    def __init__(self, prefix: str = "telemetry_stability_index_industrial_metrology_ct"):
        self.prefix = prefix
        self.stats_ = {}
