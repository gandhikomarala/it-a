# EfficiencyDegradationPaceExtractor_Industrialmetrologyct (Industrial X-Ray Computed Tomography)
...
class EfficiencyDegradationPaceExtractor_Industrialmetrologyct(BaseEstimator, TransformerMixin):
    """EfficiencyDegradationPaceExtractor_Industrialmetrologyct: Calculates the second-order derivative of thermal and power efficiency."""
    def __init__(self, prefix: str = "efficiency_degradation_pace_industrial_metrology_ct"):
        self.prefix = prefix
        self.stats_ = {}
