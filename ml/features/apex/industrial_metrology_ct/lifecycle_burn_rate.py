# LifecycleBurnRateExtractor_Industrialmetrologyct (Industrial X-Ray Computed Tomography)
...
class LifecycleBurnRateExtractor_Industrialmetrologyct(BaseEstimator, TransformerMixin):
    """LifecycleBurnRateExtractor_Industrialmetrologyct: Measures operating hours consumed against rated mean time between failures."""
    def __init__(self, prefix: str = "lifecycle_burn_rate_industrial_metrology_ct"):
        self.prefix = prefix
        self.stats_ = {}
