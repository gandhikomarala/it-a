# EfficiencyDegradationPaceExtractor_Hftmarketmaking (High-Frequency Trading & Market Making)
...
class EfficiencyDegradationPaceExtractor_Hftmarketmaking(BaseEstimator, TransformerMixin):
    """EfficiencyDegradationPaceExtractor_Hftmarketmaking: Calculates the second-order derivative of thermal and power efficiency."""
    def __init__(self, prefix: str = "efficiency_degradation_pace_hft_market_making"):
        self.prefix = prefix
        self.stats_ = {}
