# TelemetryStabilityIndexExtractor_Quantumgravimetrysensors (Cold Atom Quantum Gravimetry Sensors)
...
class TelemetryStabilityIndexExtractor_Quantumgravimetrysensors(BaseEstimator, TransformerMixin):
    """TelemetryStabilityIndexExtractor_Quantumgravimetrysensors: Measures sensor telemetry noise-to-signal ratio and stability."""
    def __init__(self, prefix: str = "telemetry_stability_index_quantum_gravimetry_sensors"):
        self.prefix = prefix
        self.stats_ = {}
