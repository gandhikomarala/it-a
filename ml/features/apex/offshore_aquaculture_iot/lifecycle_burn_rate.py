# LifecycleBurnRateExtractor_Offshoreaquacultureiot (Open-Ocean Smart Aquaculture Cages)
...
class LifecycleBurnRateExtractor_Offshoreaquacultureiot(BaseEstimator, TransformerMixin):
    """LifecycleBurnRateExtractor_Offshoreaquacultureiot: Measures operating hours consumed against rated mean time between failures."""
    def __init__(self, prefix: str = "lifecycle_burn_rate_offshore_aquaculture_iot"):
        self.prefix = prefix
        self.stats_ = {}
