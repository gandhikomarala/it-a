# SystemEntropyScoreExtractor_Offshoreaquacultureiot (Open-Ocean Smart Aquaculture Cages)
...
class SystemEntropyScoreExtractor_Offshoreaquacultureiot(BaseEstimator, TransformerMixin):
    """SystemEntropyScoreExtractor_Offshoreaquacultureiot: Shannon information entropy computed across multi-channel telemetry streams."""
    def __init__(self, prefix: str = "system_entropy_score_offshore_aquaculture_iot"):
        self.prefix = prefix
        self.stats_ = {}
