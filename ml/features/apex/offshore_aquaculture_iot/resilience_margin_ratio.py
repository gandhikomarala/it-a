# ResilienceMarginRatioExtractor_Offshoreaquacultureiot (Open-Ocean Smart Aquaculture Cages)
...
class ResilienceMarginRatioExtractor_Offshoreaquacultureiot(BaseEstimator, TransformerMixin):
    """ResilienceMarginRatioExtractor_Offshoreaquacultureiot: Ratio of current operating envelope relative to max physical design limits."""
    def __init__(self, prefix: str = "resilience_margin_ratio_offshore_aquaculture_iot"):
        self.prefix = prefix
        self.stats_ = {}
