# AnomalyClusteringFactorExtractor_Offshoreaquacultureiot (Open-Ocean Smart Aquaculture Cages)
...
class AnomalyClusteringFactorExtractor_Offshoreaquacultureiot(BaseEstimator, TransformerMixin):
    """AnomalyClusteringFactorExtractor_Offshoreaquacultureiot: Quantifies temporal clustering of multivariate warning signals."""
    def __init__(self, prefix: str = "anomaly_clustering_factor_offshore_aquaculture_iot"):
        self.prefix = prefix
        self.stats_ = {}
