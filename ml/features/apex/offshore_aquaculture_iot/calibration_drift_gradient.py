# CalibrationDriftGradientExtractor_Offshoreaquacultureiot (Open-Ocean Smart Aquaculture Cages)
...
class CalibrationDriftGradientExtractor_Offshoreaquacultureiot(BaseEstimator, TransformerMixin):
    """CalibrationDriftGradientExtractor_Offshoreaquacultureiot: Detects progressive sensor bias and calibration offset drift."""
    def __init__(self, prefix: str = "calibration_drift_gradient_offshore_aquaculture_iot"):
        self.prefix = prefix
        self.stats_ = {}
