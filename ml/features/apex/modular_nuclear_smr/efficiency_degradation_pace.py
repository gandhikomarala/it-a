# EfficiencyDegradationPaceExtractor_Modularnuclearsmr (Small Modular Nuclear Reactor (SMR) Systems)
...
class EfficiencyDegradationPaceExtractor_Modularnuclearsmr(BaseEstimator, TransformerMixin):
    """EfficiencyDegradationPaceExtractor_Modularnuclearsmr: Calculates the second-order derivative of thermal and power efficiency."""
    def __init__(self, prefix: str = "efficiency_degradation_pace_modular_nuclear_smr"):
        self.prefix = prefix
        self.stats_ = {}
