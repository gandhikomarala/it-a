# TelemetryStabilityIndexExtractor_Modularnuclearsmr (Small Modular Nuclear Reactor (SMR) Systems)
...
class TelemetryStabilityIndexExtractor_Modularnuclearsmr(BaseEstimator, TransformerMixin):
    """TelemetryStabilityIndexExtractor_Modularnuclearsmr: Measures sensor telemetry noise-to-signal ratio and stability."""
    def __init__(self, prefix: str = "telemetry_stability_index_modular_nuclear_smr"):
        self.prefix = prefix
        self.stats_ = {}
