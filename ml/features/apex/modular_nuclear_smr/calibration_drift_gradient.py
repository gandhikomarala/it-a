# CalibrationDriftGradientExtractor_Modularnuclearsmr (Small Modular Nuclear Reactor (SMR) Systems)
...
class CalibrationDriftGradientExtractor_Modularnuclearsmr(BaseEstimator, TransformerMixin):
    """CalibrationDriftGradientExtractor_Modularnuclearsmr: Detects progressive sensor bias and calibration offset drift."""
    def __init__(self, prefix: str = "calibration_drift_gradient_modular_nuclear_smr"):
        self.prefix = prefix
        self.stats_ = {}
