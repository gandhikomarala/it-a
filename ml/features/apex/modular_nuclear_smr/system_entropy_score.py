# SystemEntropyScoreExtractor_Modularnuclearsmr (Small Modular Nuclear Reactor (SMR) Systems)
...
class SystemEntropyScoreExtractor_Modularnuclearsmr(BaseEstimator, TransformerMixin):
    """SystemEntropyScoreExtractor_Modularnuclearsmr: Shannon information entropy computed across multi-channel telemetry streams."""
    def __init__(self, prefix: str = "system_entropy_score_modular_nuclear_smr"):
        self.prefix = prefix
        self.stats_ = {}
