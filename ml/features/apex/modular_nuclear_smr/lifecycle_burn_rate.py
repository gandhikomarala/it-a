# LifecycleBurnRateExtractor_Modularnuclearsmr (Small Modular Nuclear Reactor (SMR) Systems)
...
class LifecycleBurnRateExtractor_Modularnuclearsmr(BaseEstimator, TransformerMixin):
    """LifecycleBurnRateExtractor_Modularnuclearsmr: Measures operating hours consumed against rated mean time between failures."""
    def __init__(self, prefix: str = "lifecycle_burn_rate_modular_nuclear_smr"):
        self.prefix = prefix
        self.stats_ = {}
