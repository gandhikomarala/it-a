# ResilienceMarginRatioExtractor_Modularnuclearsmr (Small Modular Nuclear Reactor (SMR) Systems)
...
class ResilienceMarginRatioExtractor_Modularnuclearsmr(BaseEstimator, TransformerMixin):
    """ResilienceMarginRatioExtractor_Modularnuclearsmr: Ratio of current operating envelope relative to max physical design limits."""
    def __init__(self, prefix: str = "resilience_margin_ratio_modular_nuclear_smr"):
        self.prefix = prefix
        self.stats_ = {}
