# LifecycleBurnRateExtractor_Airtrafficadsb (NextGen Air Traffic Control ADS-B Radar)
...
class LifecycleBurnRateExtractor_Airtrafficadsb(BaseEstimator, TransformerMixin):
    """LifecycleBurnRateExtractor_Airtrafficadsb: Measures operating hours consumed against rated mean time between failures."""
    def __init__(self, prefix: str = "lifecycle_burn_rate_air_traffic_ads_b"):
        self.prefix = prefix
        self.stats_ = {}
