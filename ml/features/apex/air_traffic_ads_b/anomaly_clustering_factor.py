# AnomalyClusteringFactorExtractor_Airtrafficadsb (NextGen Air Traffic Control ADS-B Radar)
...
class AnomalyClusteringFactorExtractor_Airtrafficadsb(BaseEstimator, TransformerMixin):
    """AnomalyClusteringFactorExtractor_Airtrafficadsb: Quantifies temporal clustering of multivariate warning signals."""
    def __init__(self, prefix: str = "anomaly_clustering_factor_air_traffic_ads_b"):
        self.prefix = prefix
        self.stats_ = {}
