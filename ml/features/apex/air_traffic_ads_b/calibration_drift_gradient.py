# CalibrationDriftGradientExtractor_Airtrafficadsb (NextGen Air Traffic Control ADS-B Radar)
...
class CalibrationDriftGradientExtractor_Airtrafficadsb(BaseEstimator, TransformerMixin):
    """CalibrationDriftGradientExtractor_Airtrafficadsb: Detects progressive sensor bias and calibration offset drift."""
    def __init__(self, prefix: str = "calibration_drift_gradient_air_traffic_ads_b"):
        self.prefix = prefix
        self.stats_ = {}
