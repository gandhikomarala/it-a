# SystemEntropyScoreExtractor_Airtrafficadsb (NextGen Air Traffic Control ADS-B Radar)
...
class SystemEntropyScoreExtractor_Airtrafficadsb(BaseEstimator, TransformerMixin):
    """SystemEntropyScoreExtractor_Airtrafficadsb: Shannon information entropy computed across multi-channel telemetry streams."""
    def __init__(self, prefix: str = "system_entropy_score_air_traffic_ads_b"):
        self.prefix = prefix
        self.stats_ = {}
