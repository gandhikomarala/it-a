# TelemetryStabilityIndexExtractor_Airtrafficadsb (NextGen Air Traffic Control ADS-B Radar)
...
class TelemetryStabilityIndexExtractor_Airtrafficadsb(BaseEstimator, TransformerMixin):
    """TelemetryStabilityIndexExtractor_Airtrafficadsb: Measures sensor telemetry noise-to-signal ratio and stability."""
    def __init__(self, prefix: str = "telemetry_stability_index_air_traffic_ads_b"):
        self.prefix = prefix
        self.stats_ = {}
