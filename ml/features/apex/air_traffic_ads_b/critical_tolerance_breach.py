# CriticalToleranceBreachExtractor_Airtrafficadsb (NextGen Air Traffic Control ADS-B Radar)
...
class CriticalToleranceBreachExtractor_Airtrafficadsb(BaseEstimator, TransformerMixin):
    """CriticalToleranceBreachExtractor_Airtrafficadsb: Counts excursions past calibrated physical operating safety bounds."""
    def __init__(self, prefix: str = "critical_tolerance_breach_air_traffic_ads_b"):
        self.prefix = prefix
        self.stats_ = {}
