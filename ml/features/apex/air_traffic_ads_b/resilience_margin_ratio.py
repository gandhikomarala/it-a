# ResilienceMarginRatioExtractor_Airtrafficadsb (NextGen Air Traffic Control ADS-B Radar)
...
class ResilienceMarginRatioExtractor_Airtrafficadsb(BaseEstimator, TransformerMixin):
    """ResilienceMarginRatioExtractor_Airtrafficadsb: Ratio of current operating envelope relative to max physical design limits."""
    def __init__(self, prefix: str = "resilience_margin_ratio_air_traffic_ads_b"):
        self.prefix = prefix
        self.stats_ = {}
