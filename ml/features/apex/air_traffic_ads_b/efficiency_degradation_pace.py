# EfficiencyDegradationPaceExtractor_Airtrafficadsb (NextGen Air Traffic Control ADS-B Radar)
...
class EfficiencyDegradationPaceExtractor_Airtrafficadsb(BaseEstimator, TransformerMixin):
    """EfficiencyDegradationPaceExtractor_Airtrafficadsb: Calculates the second-order derivative of thermal and power efficiency."""
    def __init__(self, prefix: str = "efficiency_degradation_pace_air_traffic_ads_b"):
        self.prefix = prefix
        self.stats_ = {}
