# CalibrationDriftGradientExtractor_Geostationarycommsatpayload (GEO High-Throughput Satellite Spot Beams)
...
class CalibrationDriftGradientExtractor_Geostationarycommsatpayload(BaseEstimator, TransformerMixin):
    """CalibrationDriftGradientExtractor_Geostationarycommsatpayload: Detects progressive sensor bias and calibration offset drift."""
    def __init__(self, prefix: str = "calibration_drift_gradient_geostationary_commsat_payload"):
        self.prefix = prefix
        self.stats_ = {}
