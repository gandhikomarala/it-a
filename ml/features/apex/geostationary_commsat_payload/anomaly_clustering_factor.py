# AnomalyClusteringFactorExtractor_Geostationarycommsatpayload (GEO High-Throughput Satellite Spot Beams)
...
class AnomalyClusteringFactorExtractor_Geostationarycommsatpayload(BaseEstimator, TransformerMixin):
    """AnomalyClusteringFactorExtractor_Geostationarycommsatpayload: Quantifies temporal clustering of multivariate warning signals."""
    def __init__(self, prefix: str = "anomaly_clustering_factor_geostationary_commsat_payload"):
        self.prefix = prefix
        self.stats_ = {}
