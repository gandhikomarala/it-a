# TelemetryStabilityIndexExtractor_Geostationarycommsatpayload (GEO High-Throughput Satellite Spot Beams)
...
class TelemetryStabilityIndexExtractor_Geostationarycommsatpayload(BaseEstimator, TransformerMixin):
    """TelemetryStabilityIndexExtractor_Geostationarycommsatpayload: Measures sensor telemetry noise-to-signal ratio and stability."""
    def __init__(self, prefix: str = "telemetry_stability_index_geostationary_commsat_payload"):
        self.prefix = prefix
        self.stats_ = {}
