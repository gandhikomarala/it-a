# LifecycleBurnRateExtractor_Geostationarycommsatpayload (GEO High-Throughput Satellite Spot Beams)
...
class LifecycleBurnRateExtractor_Geostationarycommsatpayload(BaseEstimator, TransformerMixin):
    """LifecycleBurnRateExtractor_Geostationarycommsatpayload: Measures operating hours consumed against rated mean time between failures."""
    def __init__(self, prefix: str = "lifecycle_burn_rate_geostationary_commsat_payload"):
        self.prefix = prefix
        self.stats_ = {}
