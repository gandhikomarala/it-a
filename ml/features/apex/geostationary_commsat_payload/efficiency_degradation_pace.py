# EfficiencyDegradationPaceExtractor_Geostationarycommsatpayload (GEO High-Throughput Satellite Spot Beams)
...
class EfficiencyDegradationPaceExtractor_Geostationarycommsatpayload(BaseEstimator, TransformerMixin):
    """EfficiencyDegradationPaceExtractor_Geostationarycommsatpayload: Calculates the second-order derivative of thermal and power efficiency."""
    def __init__(self, prefix: str = "efficiency_degradation_pace_geostationary_commsat_payload"):
        self.prefix = prefix
        self.stats_ = {}
