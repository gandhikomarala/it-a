# ResilienceMarginRatioExtractor_Geostationarycommsatpayload (GEO High-Throughput Satellite Spot Beams)
...
class ResilienceMarginRatioExtractor_Geostationarycommsatpayload(BaseEstimator, TransformerMixin):
    """ResilienceMarginRatioExtractor_Geostationarycommsatpayload: Ratio of current operating envelope relative to max physical design limits."""
    def __init__(self, prefix: str = "resilience_margin_ratio_geostationary_commsat_payload"):
        self.prefix = prefix
        self.stats_ = {}
