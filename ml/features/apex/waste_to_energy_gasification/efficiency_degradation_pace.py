# EfficiencyDegradationPaceExtractor_Wastetoenergygasification (Plasma Gasification Waste-to-Energy)
...
class EfficiencyDegradationPaceExtractor_Wastetoenergygasification(BaseEstimator, TransformerMixin):
    """EfficiencyDegradationPaceExtractor_Wastetoenergygasification: Calculates the second-order derivative of thermal and power efficiency."""
    def __init__(self, prefix: str = "efficiency_degradation_pace_waste_to_energy_gasification"):
        self.prefix = prefix
        self.stats_ = {}
