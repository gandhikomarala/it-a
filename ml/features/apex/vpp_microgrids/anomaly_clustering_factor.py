# AnomalyClusteringFactorExtractor_Vppmicrogrids (Virtual Power Plants & Microgrid Orchestration)
...
class AnomalyClusteringFactorExtractor_Vppmicrogrids(BaseEstimator, TransformerMixin):
    """AnomalyClusteringFactorExtractor_Vppmicrogrids: Quantifies temporal clustering of multivariate warning signals."""
    def __init__(self, prefix: str = "anomaly_clustering_factor_vpp_microgrids"):
        self.prefix = prefix
        self.stats_ = {}
