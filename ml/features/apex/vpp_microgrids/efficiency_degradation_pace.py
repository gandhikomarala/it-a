# EfficiencyDegradationPaceExtractor_Vppmicrogrids (Virtual Power Plants & Microgrid Orchestration)
...
class EfficiencyDegradationPaceExtractor_Vppmicrogrids(BaseEstimator, TransformerMixin):
    """EfficiencyDegradationPaceExtractor_Vppmicrogrids: Calculates the second-order derivative of thermal and power efficiency."""
    def __init__(self, prefix: str = "efficiency_degradation_pace_vpp_microgrids"):
        self.prefix = prefix
        self.stats_ = {}
