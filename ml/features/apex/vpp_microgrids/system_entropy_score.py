# SystemEntropyScoreExtractor_Vppmicrogrids (Virtual Power Plants & Microgrid Orchestration)
...
class SystemEntropyScoreExtractor_Vppmicrogrids(BaseEstimator, TransformerMixin):
    """SystemEntropyScoreExtractor_Vppmicrogrids: Shannon information entropy computed across multi-channel telemetry streams."""
    def __init__(self, prefix: str = "system_entropy_score_vpp_microgrids"):
        self.prefix = prefix
        self.stats_ = {}
