# CriticalToleranceBreachExtractor_Vppmicrogrids (Virtual Power Plants & Microgrid Orchestration)
...
class CriticalToleranceBreachExtractor_Vppmicrogrids(BaseEstimator, TransformerMixin):
    """CriticalToleranceBreachExtractor_Vppmicrogrids: Counts excursions past calibrated physical operating safety bounds."""
    def __init__(self, prefix: str = "critical_tolerance_breach_vpp_microgrids"):
        self.prefix = prefix
        self.stats_ = {}
