# ResilienceMarginRatioExtractor_Vppmicrogrids (Virtual Power Plants & Microgrid Orchestration)
...
class ResilienceMarginRatioExtractor_Vppmicrogrids(BaseEstimator, TransformerMixin):
    """ResilienceMarginRatioExtractor_Vppmicrogrids: Ratio of current operating envelope relative to max physical design limits."""
    def __init__(self, prefix: str = "resilience_margin_ratio_vpp_microgrids"):
        self.prefix = prefix
        self.stats_ = {}
