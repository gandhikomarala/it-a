# ResilienceMarginRatioExtractor_Autonomouscargoships (Autonomous Trans-Oceanic Cargo Ships)
...
class ResilienceMarginRatioExtractor_Autonomouscargoships(BaseEstimator, TransformerMixin):
    """ResilienceMarginRatioExtractor_Autonomouscargoships: Ratio of current operating envelope relative to max physical design limits."""
    def __init__(self, prefix: str = "resilience_margin_ratio_autonomous_cargo_ships"):
        self.prefix = prefix
        self.stats_ = {}
