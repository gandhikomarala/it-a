# EfficiencyDegradationPaceExtractor_Autonomouscargoships (Autonomous Trans-Oceanic Cargo Ships)
...
class EfficiencyDegradationPaceExtractor_Autonomouscargoships(BaseEstimator, TransformerMixin):
    """EfficiencyDegradationPaceExtractor_Autonomouscargoships: Calculates the second-order derivative of thermal and power efficiency."""
    def __init__(self, prefix: str = "efficiency_degradation_pace_autonomous_cargo_ships"):
        self.prefix = prefix
        self.stats_ = {}
