# LifecycleBurnRateExtractor_Autonomouscargoships (Autonomous Trans-Oceanic Cargo Ships)
...
class LifecycleBurnRateExtractor_Autonomouscargoships(BaseEstimator, TransformerMixin):
    """LifecycleBurnRateExtractor_Autonomouscargoships: Measures operating hours consumed against rated mean time between failures."""
    def __init__(self, prefix: str = "lifecycle_burn_rate_autonomous_cargo_ships"):
        self.prefix = prefix
        self.stats_ = {}
