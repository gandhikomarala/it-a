# LifecycleBurnRateExtractor_Hypersonicaerodynamics (Hypersonic Scramjet Aerothermal Sensors)
...
class LifecycleBurnRateExtractor_Hypersonicaerodynamics(BaseEstimator, TransformerMixin):
    """LifecycleBurnRateExtractor_Hypersonicaerodynamics: Measures operating hours consumed against rated mean time between failures."""
    def __init__(self, prefix: str = "lifecycle_burn_rate_hypersonic_aerodynamics"):
        self.prefix = prefix
        self.stats_ = {}
