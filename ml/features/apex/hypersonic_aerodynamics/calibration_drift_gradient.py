# CalibrationDriftGradientExtractor_Hypersonicaerodynamics (Hypersonic Scramjet Aerothermal Sensors)
...
class CalibrationDriftGradientExtractor_Hypersonicaerodynamics(BaseEstimator, TransformerMixin):
    """CalibrationDriftGradientExtractor_Hypersonicaerodynamics: Detects progressive sensor bias and calibration offset drift."""
    def __init__(self, prefix: str = "calibration_drift_gradient_hypersonic_aerodynamics"):
        self.prefix = prefix
        self.stats_ = {}
