# AnomalyClusteringFactorExtractor_Hypersonicaerodynamics (Hypersonic Scramjet Aerothermal Sensors)
...
class AnomalyClusteringFactorExtractor_Hypersonicaerodynamics(BaseEstimator, TransformerMixin):
    """AnomalyClusteringFactorExtractor_Hypersonicaerodynamics: Quantifies temporal clustering of multivariate warning signals."""
    def __init__(self, prefix: str = "anomaly_clustering_factor_hypersonic_aerodynamics"):
        self.prefix = prefix
        self.stats_ = {}
