# TelemetryStabilityIndexExtractor_Hypersonicaerodynamics (Hypersonic Scramjet Aerothermal Sensors)
...
class TelemetryStabilityIndexExtractor_Hypersonicaerodynamics(BaseEstimator, TransformerMixin):
    """TelemetryStabilityIndexExtractor_Hypersonicaerodynamics: Measures sensor telemetry noise-to-signal ratio and stability."""
    def __init__(self, prefix: str = "telemetry_stability_index_hypersonic_aerodynamics"):
        self.prefix = prefix
        self.stats_ = {}
