# ResilienceMarginRatioExtractor_Hypersonicaerodynamics (Hypersonic Scramjet Aerothermal Sensors)
...
class ResilienceMarginRatioExtractor_Hypersonicaerodynamics(BaseEstimator, TransformerMixin):
    """ResilienceMarginRatioExtractor_Hypersonicaerodynamics: Ratio of current operating envelope relative to max physical design limits."""
    def __init__(self, prefix: str = "resilience_margin_ratio_hypersonic_aerodynamics"):
        self.prefix = prefix
        self.stats_ = {}
