# EfficiencyDegradationPaceExtractor_Hypersonicaerodynamics (Hypersonic Scramjet Aerothermal Sensors)
...
class EfficiencyDegradationPaceExtractor_Hypersonicaerodynamics(BaseEstimator, TransformerMixin):
    """EfficiencyDegradationPaceExtractor_Hypersonicaerodynamics: Calculates the second-order derivative of thermal and power efficiency."""
    def __init__(self, prefix: str = "efficiency_degradation_pace_hypersonic_aerodynamics"):
        self.prefix = prefix
        self.stats_ = {}
