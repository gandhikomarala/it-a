# ResilienceMarginRatioExtractor_Celltherapycart (Autologous CAR-T Cell Therapy Manufacturing)
...
class ResilienceMarginRatioExtractor_Celltherapycart(BaseEstimator, TransformerMixin):
    """ResilienceMarginRatioExtractor_Celltherapycart: Ratio of current operating envelope relative to max physical design limits."""
    def __init__(self, prefix: str = "resilience_margin_ratio_cell_therapy_car_t"):
        self.prefix = prefix
        self.stats_ = {}
