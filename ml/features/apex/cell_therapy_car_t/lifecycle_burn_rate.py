# LifecycleBurnRateExtractor_Celltherapycart (Autologous CAR-T Cell Therapy Manufacturing)
...
class LifecycleBurnRateExtractor_Celltherapycart(BaseEstimator, TransformerMixin):
    """LifecycleBurnRateExtractor_Celltherapycart: Measures operating hours consumed against rated mean time between failures."""
    def __init__(self, prefix: str = "lifecycle_burn_rate_cell_therapy_car_t"):
        self.prefix = prefix
        self.stats_ = {}
