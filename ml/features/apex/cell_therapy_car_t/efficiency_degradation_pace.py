# EfficiencyDegradationPaceExtractor_Celltherapycart (Autologous CAR-T Cell Therapy Manufacturing)
...
class EfficiencyDegradationPaceExtractor_Celltherapycart(BaseEstimator, TransformerMixin):
    """EfficiencyDegradationPaceExtractor_Celltherapycart: Calculates the second-order derivative of thermal and power efficiency."""
    def __init__(self, prefix: str = "efficiency_degradation_pace_cell_therapy_car_t"):
        self.prefix = prefix
        self.stats_ = {}
