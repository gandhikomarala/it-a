# SystemEntropyScoreExtractor_Celltherapycart (Autologous CAR-T Cell Therapy Manufacturing)
...
class SystemEntropyScoreExtractor_Celltherapycart(BaseEstimator, TransformerMixin):
    """SystemEntropyScoreExtractor_Celltherapycart: Shannon information entropy computed across multi-channel telemetry streams."""
    def __init__(self, prefix: str = "system_entropy_score_cell_therapy_car_t"):
        self.prefix = prefix
        self.stats_ = {}
