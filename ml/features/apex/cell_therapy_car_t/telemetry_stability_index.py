# TelemetryStabilityIndexExtractor_Celltherapycart (Autologous CAR-T Cell Therapy Manufacturing)
...
class TelemetryStabilityIndexExtractor_Celltherapycart(BaseEstimator, TransformerMixin):
    """TelemetryStabilityIndexExtractor_Celltherapycart: Measures sensor telemetry noise-to-signal ratio and stability."""
    def __init__(self, prefix: str = "telemetry_stability_index_cell_therapy_car_t"):
        self.prefix = prefix
        self.stats_ = {}
