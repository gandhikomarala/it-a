# CalibrationDriftGradientExtractor_Celltherapycart (Autologous CAR-T Cell Therapy Manufacturing)
...
class CalibrationDriftGradientExtractor_Celltherapycart(BaseEstimator, TransformerMixin):
    """CalibrationDriftGradientExtractor_Celltherapycart: Detects progressive sensor bias and calibration offset drift."""
    def __init__(self, prefix: str = "calibration_drift_gradient_cell_therapy_car_t"):
        self.prefix = prefix
        self.stats_ = {}
