# AnomalyClusteringFactorExtractor_Celltherapycart (Autologous CAR-T Cell Therapy Manufacturing)
...
class AnomalyClusteringFactorExtractor_Celltherapycart(BaseEstimator, TransformerMixin):
    """AnomalyClusteringFactorExtractor_Celltherapycart: Quantifies temporal clustering of multivariate warning signals."""
    def __init__(self, prefix: str = "anomaly_clustering_factor_cell_therapy_car_t"):
        self.prefix = prefix
        self.stats_ = {}
