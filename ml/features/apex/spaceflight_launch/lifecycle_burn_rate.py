# LifecycleBurnRateExtractor_Spaceflightlaunch (Commercial Space Flight Launch Telemetry)
...
class LifecycleBurnRateExtractor_Spaceflightlaunch(BaseEstimator, TransformerMixin):
    """LifecycleBurnRateExtractor_Spaceflightlaunch: Measures operating hours consumed against rated mean time between failures."""
    def __init__(self, prefix: str = "lifecycle_burn_rate_spaceflight_launch"):
        self.prefix = prefix
        self.stats_ = {}
