# LifecycleBurnRateExtractor_Evfleetcharging (Commercial Electric Vehicle Fleet Charging)
...
class LifecycleBurnRateExtractor_Evfleetcharging(BaseEstimator, TransformerMixin):
    """LifecycleBurnRateExtractor_Evfleetcharging: Measures operating hours consumed against rated mean time between failures."""
    def __init__(self, prefix: str = "lifecycle_burn_rate_ev_fleet_charging"):
        self.prefix = prefix
        self.stats_ = {}
