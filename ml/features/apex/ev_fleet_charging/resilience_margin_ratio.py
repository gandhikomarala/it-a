# ResilienceMarginRatioExtractor_Evfleetcharging (Commercial Electric Vehicle Fleet Charging)
...
class ResilienceMarginRatioExtractor_Evfleetcharging(BaseEstimator, TransformerMixin):
    """ResilienceMarginRatioExtractor_Evfleetcharging: Ratio of current operating envelope relative to max physical design limits."""
    def __init__(self, prefix: str = "resilience_margin_ratio_ev_fleet_charging"):
        self.prefix = prefix
        self.stats_ = {}
