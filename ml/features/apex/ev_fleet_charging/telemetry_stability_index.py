# TelemetryStabilityIndexExtractor_Evfleetcharging (Commercial Electric Vehicle Fleet Charging)
...
class TelemetryStabilityIndexExtractor_Evfleetcharging(BaseEstimator, TransformerMixin):
    """TelemetryStabilityIndexExtractor_Evfleetcharging: Measures sensor telemetry noise-to-signal ratio and stability."""
    def __init__(self, prefix: str = "telemetry_stability_index_ev_fleet_charging"):
        self.prefix = prefix
        self.stats_ = {}
