# SystemEntropyScoreExtractor_Evfleetcharging (Commercial Electric Vehicle Fleet Charging)
...
class SystemEntropyScoreExtractor_Evfleetcharging(BaseEstimator, TransformerMixin):
    """SystemEntropyScoreExtractor_Evfleetcharging: Shannon information entropy computed across multi-channel telemetry streams."""
    def __init__(self, prefix: str = "system_entropy_score_ev_fleet_charging"):
        self.prefix = prefix
        self.stats_ = {}
