# TelemetryStabilityIndexExtractor_Avlidarpointcloud (Frequency Modulated Continuous Wave (FMCW) LiDAR)
...
class TelemetryStabilityIndexExtractor_Avlidarpointcloud(BaseEstimator, TransformerMixin):
    """TelemetryStabilityIndexExtractor_Avlidarpointcloud: Measures sensor telemetry noise-to-signal ratio and stability."""
    def __init__(self, prefix: str = "telemetry_stability_index_av_lidar_pointcloud"):
        self.prefix = prefix
        self.stats_ = {}
