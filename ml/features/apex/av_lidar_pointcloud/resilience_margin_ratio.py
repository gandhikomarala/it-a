# ResilienceMarginRatioExtractor_Avlidarpointcloud (Frequency Modulated Continuous Wave (FMCW) LiDAR)
...
class ResilienceMarginRatioExtractor_Avlidarpointcloud(BaseEstimator, TransformerMixin):
    """ResilienceMarginRatioExtractor_Avlidarpointcloud: Ratio of current operating envelope relative to max physical design limits."""
    def __init__(self, prefix: str = "resilience_margin_ratio_av_lidar_pointcloud"):
        self.prefix = prefix
        self.stats_ = {}
