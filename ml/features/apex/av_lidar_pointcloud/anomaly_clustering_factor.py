# AnomalyClusteringFactorExtractor_Avlidarpointcloud (Frequency Modulated Continuous Wave (FMCW) LiDAR)
...
class AnomalyClusteringFactorExtractor_Avlidarpointcloud(BaseEstimator, TransformerMixin):
    """AnomalyClusteringFactorExtractor_Avlidarpointcloud: Quantifies temporal clustering of multivariate warning signals."""
    def __init__(self, prefix: str = "anomaly_clustering_factor_av_lidar_pointcloud"):
        self.prefix = prefix
        self.stats_ = {}
