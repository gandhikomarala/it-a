# AnomalyClusteringFactorExtractor_Smarthighwayweighinmotion (High-Speed Highway Weigh-in-Motion)
...
class AnomalyClusteringFactorExtractor_Smarthighwayweighinmotion(BaseEstimator, TransformerMixin):
    """AnomalyClusteringFactorExtractor_Smarthighwayweighinmotion: Quantifies temporal clustering of multivariate warning signals."""
    def __init__(self, prefix: str = "anomaly_clustering_factor_smart_highway_weigh_in_motion"):
        self.prefix = prefix
        self.stats_ = {}
