# CalibrationDriftGradientExtractor_Smarthighwayweighinmotion (High-Speed Highway Weigh-in-Motion)
...
class CalibrationDriftGradientExtractor_Smarthighwayweighinmotion(BaseEstimator, TransformerMixin):
    """CalibrationDriftGradientExtractor_Smarthighwayweighinmotion: Detects progressive sensor bias and calibration offset drift."""
    def __init__(self, prefix: str = "calibration_drift_gradient_smart_highway_weigh_in_motion"):
        self.prefix = prefix
        self.stats_ = {}
