# EfficiencyDegradationPaceExtractor_Smarthighwayweighinmotion (High-Speed Highway Weigh-in-Motion)
...
class EfficiencyDegradationPaceExtractor_Smarthighwayweighinmotion(BaseEstimator, TransformerMixin):
    """EfficiencyDegradationPaceExtractor_Smarthighwayweighinmotion: Calculates the second-order derivative of thermal and power efficiency."""
    def __init__(self, prefix: str = "efficiency_degradation_pace_smart_highway_weigh_in_motion"):
        self.prefix = prefix
        self.stats_ = {}
