# SystemEntropyScoreExtractor_Smarthighwayweighinmotion (High-Speed Highway Weigh-in-Motion)
...
class SystemEntropyScoreExtractor_Smarthighwayweighinmotion(BaseEstimator, TransformerMixin):
    """SystemEntropyScoreExtractor_Smarthighwayweighinmotion: Shannon information entropy computed across multi-channel telemetry streams."""
    def __init__(self, prefix: str = "system_entropy_score_smart_highway_weigh_in_motion"):
        self.prefix = prefix
        self.stats_ = {}
