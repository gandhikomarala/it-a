# TelemetryStabilityIndexExtractor_Smarthighwayweighinmotion (High-Speed Highway Weigh-in-Motion)
...
class TelemetryStabilityIndexExtractor_Smarthighwayweighinmotion(BaseEstimator, TransformerMixin):
    """TelemetryStabilityIndexExtractor_Smarthighwayweighinmotion: Measures sensor telemetry noise-to-signal ratio and stability."""
    def __init__(self, prefix: str = "telemetry_stability_index_smart_highway_weigh_in_motion"):
        self.prefix = prefix
        self.stats_ = {}
