# ResilienceMarginRatioExtractor_Smarthighwayweighinmotion (High-Speed Highway Weigh-in-Motion)
...
class ResilienceMarginRatioExtractor_Smarthighwayweighinmotion(BaseEstimator, TransformerMixin):
    """ResilienceMarginRatioExtractor_Smarthighwayweighinmotion: Ratio of current operating envelope relative to max physical design limits."""
    def __init__(self, prefix: str = "resilience_margin_ratio_smart_highway_weigh_in_motion"):
        self.prefix = prefix
        self.stats_ = {}
