# LifecycleBurnRateExtractor_Fusionenergyplasma (Tokamak Fusion Energy Plasma Confinement)
...
class LifecycleBurnRateExtractor_Fusionenergyplasma(BaseEstimator, TransformerMixin):
    """LifecycleBurnRateExtractor_Fusionenergyplasma: Measures operating hours consumed against rated mean time between failures."""
    def __init__(self, prefix: str = "lifecycle_burn_rate_fusion_energy_plasma"):
        self.prefix = prefix
        self.stats_ = {}
