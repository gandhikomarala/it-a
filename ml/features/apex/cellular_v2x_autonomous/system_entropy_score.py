# SystemEntropyScoreExtractor_Cellularv2Xautonomous (Cellular V2X Connected Vehicle Telemetry)
...
class SystemEntropyScoreExtractor_Cellularv2Xautonomous(BaseEstimator, TransformerMixin):
    """SystemEntropyScoreExtractor_Cellularv2Xautonomous: Shannon information entropy computed across multi-channel telemetry streams."""
    def __init__(self, prefix: str = "system_entropy_score_cellular_v2x_autonomous"):
        self.prefix = prefix
        self.stats_ = {}
