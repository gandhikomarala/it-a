# ResilienceMarginRatioExtractor_Cellularv2Xautonomous (Cellular V2X Connected Vehicle Telemetry)
...
class ResilienceMarginRatioExtractor_Cellularv2Xautonomous(BaseEstimator, TransformerMixin):
    """ResilienceMarginRatioExtractor_Cellularv2Xautonomous: Ratio of current operating envelope relative to max physical design limits."""
    def __init__(self, prefix: str = "resilience_margin_ratio_cellular_v2x_autonomous"):
        self.prefix = prefix
        self.stats_ = {}
