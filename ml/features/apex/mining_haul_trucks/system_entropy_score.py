# SystemEntropyScoreExtractor_Mininghaultrucks (Autonomous Mining Haul Truck Fleets)
...
class SystemEntropyScoreExtractor_Mininghaultrucks(BaseEstimator, TransformerMixin):
    """SystemEntropyScoreExtractor_Mininghaultrucks: Shannon information entropy computed across multi-channel telemetry streams."""
    def __init__(self, prefix: str = "system_entropy_score_mining_haul_trucks"):
        self.prefix = prefix
        self.stats_ = {}
