# TelemetryStabilityIndexExtractor_Mininghaultrucks (Autonomous Mining Haul Truck Fleets)
...
class TelemetryStabilityIndexExtractor_Mininghaultrucks(BaseEstimator, TransformerMixin):
    """TelemetryStabilityIndexExtractor_Mininghaultrucks: Measures sensor telemetry noise-to-signal ratio and stability."""
    def __init__(self, prefix: str = "telemetry_stability_index_mining_haul_trucks"):
        self.prefix = prefix
        self.stats_ = {}
