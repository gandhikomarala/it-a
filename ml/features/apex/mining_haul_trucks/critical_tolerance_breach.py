# CriticalToleranceBreachExtractor_Mininghaultrucks (Autonomous Mining Haul Truck Fleets)
...
class CriticalToleranceBreachExtractor_Mininghaultrucks(BaseEstimator, TransformerMixin):
    """CriticalToleranceBreachExtractor_Mininghaultrucks: Counts excursions past calibrated physical operating safety bounds."""
    def __init__(self, prefix: str = "critical_tolerance_breach_mining_haul_trucks"):
        self.prefix = prefix
        self.stats_ = {}
