# ResilienceMarginRatioExtractor_Mininghaultrucks (Autonomous Mining Haul Truck Fleets)
...
class ResilienceMarginRatioExtractor_Mininghaultrucks(BaseEstimator, TransformerMixin):
    """ResilienceMarginRatioExtractor_Mininghaultrucks: Ratio of current operating envelope relative to max physical design limits."""
    def __init__(self, prefix: str = "resilience_margin_ratio_mining_haul_trucks"):
        self.prefix = prefix
        self.stats_ = {}
