# EfficiencyDegradationPaceExtractor_Mininghaultrucks (Autonomous Mining Haul Truck Fleets)
...
class EfficiencyDegradationPaceExtractor_Mininghaultrucks(BaseEstimator, TransformerMixin):
    """EfficiencyDegradationPaceExtractor_Mininghaultrucks: Calculates the second-order derivative of thermal and power efficiency."""
    def __init__(self, prefix: str = "efficiency_degradation_pace_mining_haul_trucks"):
        self.prefix = prefix
        self.stats_ = {}
