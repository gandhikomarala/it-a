# LifecycleBurnRateExtractor_Mininghaultrucks (Autonomous Mining Haul Truck Fleets)
...
class LifecycleBurnRateExtractor_Mininghaultrucks(BaseEstimator, TransformerMixin):
    """LifecycleBurnRateExtractor_Mininghaultrucks: Measures operating hours consumed against rated mean time between failures."""
    def __init__(self, prefix: str = "lifecycle_burn_rate_mining_haul_trucks"):
        self.prefix = prefix
        self.stats_ = {}
