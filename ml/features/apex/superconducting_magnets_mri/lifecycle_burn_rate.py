# LifecycleBurnRateExtractor_Superconductingmagnetsmri (Ultra-High Field 7T MRI Superconducting Magnets)
...
class LifecycleBurnRateExtractor_Superconductingmagnetsmri(BaseEstimator, TransformerMixin):
    """LifecycleBurnRateExtractor_Superconductingmagnetsmri: Measures operating hours consumed against rated mean time between failures."""
    def __init__(self, prefix: str = "lifecycle_burn_rate_superconducting_magnets_mri"):
        self.prefix = prefix
        self.stats_ = {}
