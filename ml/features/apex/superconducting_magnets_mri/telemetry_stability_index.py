# TelemetryStabilityIndexExtractor_Superconductingmagnetsmri (Ultra-High Field 7T MRI Superconducting Magnets)
...
class TelemetryStabilityIndexExtractor_Superconductingmagnetsmri(BaseEstimator, TransformerMixin):
    """TelemetryStabilityIndexExtractor_Superconductingmagnetsmri: Measures sensor telemetry noise-to-signal ratio and stability."""
    def __init__(self, prefix: str = "telemetry_stability_index_superconducting_magnets_mri"):
        self.prefix = prefix
        self.stats_ = {}
