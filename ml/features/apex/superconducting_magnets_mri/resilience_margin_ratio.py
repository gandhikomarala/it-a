# ResilienceMarginRatioExtractor_Superconductingmagnetsmri (Ultra-High Field 7T MRI Superconducting Magnets)
...
class ResilienceMarginRatioExtractor_Superconductingmagnetsmri(BaseEstimator, TransformerMixin):
    """ResilienceMarginRatioExtractor_Superconductingmagnetsmri: Ratio of current operating envelope relative to max physical design limits."""
    def __init__(self, prefix: str = "resilience_margin_ratio_superconducting_magnets_mri"):
        self.prefix = prefix
        self.stats_ = {}
