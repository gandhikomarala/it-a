# LifecycleBurnRateExtractor_Deepseaminingcrawlers (Abyssal Plain Polymetallic Nodule Harvesters)
...
class LifecycleBurnRateExtractor_Deepseaminingcrawlers(BaseEstimator, TransformerMixin):
    """LifecycleBurnRateExtractor_Deepseaminingcrawlers: Measures operating hours consumed against rated mean time between failures."""
    def __init__(self, prefix: str = "lifecycle_burn_rate_deepsea_mining_crawlers"):
        self.prefix = prefix
        self.stats_ = {}
