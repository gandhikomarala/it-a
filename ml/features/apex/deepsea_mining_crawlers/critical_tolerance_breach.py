# CriticalToleranceBreachExtractor_Deepseaminingcrawlers (Abyssal Plain Polymetallic Nodule Harvesters)
...
class CriticalToleranceBreachExtractor_Deepseaminingcrawlers(BaseEstimator, TransformerMixin):
    """CriticalToleranceBreachExtractor_Deepseaminingcrawlers: Counts excursions past calibrated physical operating safety bounds."""
    def __init__(self, prefix: str = "critical_tolerance_breach_deepsea_mining_crawlers"):
        self.prefix = prefix
        self.stats_ = {}
