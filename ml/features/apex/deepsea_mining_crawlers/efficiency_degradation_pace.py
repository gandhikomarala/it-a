# EfficiencyDegradationPaceExtractor_Deepseaminingcrawlers (Abyssal Plain Polymetallic Nodule Harvesters)
...
class EfficiencyDegradationPaceExtractor_Deepseaminingcrawlers(BaseEstimator, TransformerMixin):
    """EfficiencyDegradationPaceExtractor_Deepseaminingcrawlers: Calculates the second-order derivative of thermal and power efficiency."""
    def __init__(self, prefix: str = "efficiency_degradation_pace_deepsea_mining_crawlers"):
        self.prefix = prefix
        self.stats_ = {}
