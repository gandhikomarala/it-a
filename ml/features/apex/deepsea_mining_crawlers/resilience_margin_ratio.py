# ResilienceMarginRatioExtractor_Deepseaminingcrawlers (Abyssal Plain Polymetallic Nodule Harvesters)
...
class ResilienceMarginRatioExtractor_Deepseaminingcrawlers(BaseEstimator, TransformerMixin):
    """ResilienceMarginRatioExtractor_Deepseaminingcrawlers: Ratio of current operating envelope relative to max physical design limits."""
    def __init__(self, prefix: str = "resilience_margin_ratio_deepsea_mining_crawlers"):
        self.prefix = prefix
        self.stats_ = {}
