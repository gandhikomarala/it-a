# CalibrationDriftGradientExtractor_Deepseaminingcrawlers (Abyssal Plain Polymetallic Nodule Harvesters)
...
class CalibrationDriftGradientExtractor_Deepseaminingcrawlers(BaseEstimator, TransformerMixin):
    """CalibrationDriftGradientExtractor_Deepseaminingcrawlers: Detects progressive sensor bias and calibration offset drift."""
    def __init__(self, prefix: str = "calibration_drift_gradient_deepsea_mining_crawlers"):
        self.prefix = prefix
        self.stats_ = {}
