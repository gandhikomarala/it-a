# AnomalyClusteringFactorExtractor_Deepseaminingcrawlers (Abyssal Plain Polymetallic Nodule Harvesters)
...
class AnomalyClusteringFactorExtractor_Deepseaminingcrawlers(BaseEstimator, TransformerMixin):
    """AnomalyClusteringFactorExtractor_Deepseaminingcrawlers: Quantifies temporal clustering of multivariate warning signals."""
    def __init__(self, prefix: str = "anomaly_clustering_factor_deepsea_mining_crawlers"):
        self.prefix = prefix
        self.stats_ = {}
