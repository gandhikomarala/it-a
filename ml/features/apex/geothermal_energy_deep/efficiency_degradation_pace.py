# EfficiencyDegradationPaceExtractor_Geothermalenergydeep (Enhanced Geothermal Deep Drilling Systems)
...
class EfficiencyDegradationPaceExtractor_Geothermalenergydeep(BaseEstimator, TransformerMixin):
    """EfficiencyDegradationPaceExtractor_Geothermalenergydeep: Calculates the second-order derivative of thermal and power efficiency."""
    def __init__(self, prefix: str = "efficiency_degradation_pace_geothermal_energy_deep"):
        self.prefix = prefix
        self.stats_ = {}
