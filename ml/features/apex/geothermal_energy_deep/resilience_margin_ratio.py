# ResilienceMarginRatioExtractor_Geothermalenergydeep (Enhanced Geothermal Deep Drilling Systems)
...
class ResilienceMarginRatioExtractor_Geothermalenergydeep(BaseEstimator, TransformerMixin):
    """ResilienceMarginRatioExtractor_Geothermalenergydeep: Ratio of current operating envelope relative to max physical design limits."""
    def __init__(self, prefix: str = "resilience_margin_ratio_geothermal_energy_deep"):
        self.prefix = prefix
        self.stats_ = {}
