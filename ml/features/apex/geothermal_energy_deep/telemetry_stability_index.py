# TelemetryStabilityIndexExtractor_Geothermalenergydeep (Enhanced Geothermal Deep Drilling Systems)
...
class TelemetryStabilityIndexExtractor_Geothermalenergydeep(BaseEstimator, TransformerMixin):
    """TelemetryStabilityIndexExtractor_Geothermalenergydeep: Measures sensor telemetry noise-to-signal ratio and stability."""
    def __init__(self, prefix: str = "telemetry_stability_index_geothermal_energy_deep"):
        self.prefix = prefix
        self.stats_ = {}
