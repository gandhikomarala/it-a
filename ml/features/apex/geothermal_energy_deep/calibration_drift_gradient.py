# CalibrationDriftGradientExtractor_Geothermalenergydeep (Enhanced Geothermal Deep Drilling Systems)
...
class CalibrationDriftGradientExtractor_Geothermalenergydeep(BaseEstimator, TransformerMixin):
    """CalibrationDriftGradientExtractor_Geothermalenergydeep: Detects progressive sensor bias and calibration offset drift."""
    def __init__(self, prefix: str = "calibration_drift_gradient_geothermal_energy_deep"):
        self.prefix = prefix
        self.stats_ = {}
