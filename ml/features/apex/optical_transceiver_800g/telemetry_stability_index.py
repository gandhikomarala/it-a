# TelemetryStabilityIndexExtractor_Opticaltransceiver800G (800G Silicon Photonics Optical Transceivers)
...
class TelemetryStabilityIndexExtractor_Opticaltransceiver800G(BaseEstimator, TransformerMixin):
    """TelemetryStabilityIndexExtractor_Opticaltransceiver800G: Measures sensor telemetry noise-to-signal ratio and stability."""
    def __init__(self, prefix: str = "telemetry_stability_index_optical_transceiver_800g"):
        self.prefix = prefix
        self.stats_ = {}
