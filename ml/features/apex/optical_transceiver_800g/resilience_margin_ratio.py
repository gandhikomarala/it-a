# ResilienceMarginRatioExtractor_Opticaltransceiver800G (800G Silicon Photonics Optical Transceivers)
...
class ResilienceMarginRatioExtractor_Opticaltransceiver800G(BaseEstimator, TransformerMixin):
    """ResilienceMarginRatioExtractor_Opticaltransceiver800G: Ratio of current operating envelope relative to max physical design limits."""
    def __init__(self, prefix: str = "resilience_margin_ratio_optical_transceiver_800g"):
        self.prefix = prefix
        self.stats_ = {}
