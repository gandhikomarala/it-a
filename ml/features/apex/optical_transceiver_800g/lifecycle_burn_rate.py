# LifecycleBurnRateExtractor_Opticaltransceiver800G (800G Silicon Photonics Optical Transceivers)
...
class LifecycleBurnRateExtractor_Opticaltransceiver800G(BaseEstimator, TransformerMixin):
    """LifecycleBurnRateExtractor_Opticaltransceiver800G: Measures operating hours consumed against rated mean time between failures."""
    def __init__(self, prefix: str = "lifecycle_burn_rate_optical_transceiver_800g"):
        self.prefix = prefix
        self.stats_ = {}
