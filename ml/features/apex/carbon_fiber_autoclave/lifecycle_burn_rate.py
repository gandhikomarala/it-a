# LifecycleBurnRateExtractor_Carbonfiberautoclave (Aerospace Carbon Fiber Composite Autoclaves)
...
class LifecycleBurnRateExtractor_Carbonfiberautoclave(BaseEstimator, TransformerMixin):
    """LifecycleBurnRateExtractor_Carbonfiberautoclave: Measures operating hours consumed against rated mean time between failures."""
    def __init__(self, prefix: str = "lifecycle_burn_rate_carbon_fiber_autoclave"):
        self.prefix = prefix
        self.stats_ = {}
