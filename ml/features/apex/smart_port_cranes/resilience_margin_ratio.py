# ResilienceMarginRatioExtractor_Smartportcranes (Automated Container Port STS Cranes)
...
class ResilienceMarginRatioExtractor_Smartportcranes(BaseEstimator, TransformerMixin):
    """ResilienceMarginRatioExtractor_Smartportcranes: Ratio of current operating envelope relative to max physical design limits."""
    def __init__(self, prefix: str = "resilience_margin_ratio_smart_port_cranes"):
        self.prefix = prefix
        self.stats_ = {}
