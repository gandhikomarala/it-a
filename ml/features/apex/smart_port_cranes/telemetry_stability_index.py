# TelemetryStabilityIndexExtractor_Smartportcranes (Automated Container Port STS Cranes)
...
class TelemetryStabilityIndexExtractor_Smartportcranes(BaseEstimator, TransformerMixin):
    """TelemetryStabilityIndexExtractor_Smartportcranes: Measures sensor telemetry noise-to-signal ratio and stability."""
    def __init__(self, prefix: str = "telemetry_stability_index_smart_port_cranes"):
        self.prefix = prefix
        self.stats_ = {}
