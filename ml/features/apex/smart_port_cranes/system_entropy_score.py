# SystemEntropyScoreExtractor_Smartportcranes (Automated Container Port STS Cranes)
...
class SystemEntropyScoreExtractor_Smartportcranes(BaseEstimator, TransformerMixin):
    """SystemEntropyScoreExtractor_Smartportcranes: Shannon information entropy computed across multi-channel telemetry streams."""
    def __init__(self, prefix: str = "system_entropy_score_smart_port_cranes"):
        self.prefix = prefix
        self.stats_ = {}
