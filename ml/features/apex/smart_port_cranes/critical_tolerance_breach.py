# CriticalToleranceBreachExtractor_Smartportcranes (Automated Container Port STS Cranes)
...
class CriticalToleranceBreachExtractor_Smartportcranes(BaseEstimator, TransformerMixin):
    """CriticalToleranceBreachExtractor_Smartportcranes: Counts excursions past calibrated physical operating safety bounds."""
    def __init__(self, prefix: str = "critical_tolerance_breach_smart_port_cranes"):
        self.prefix = prefix
        self.stats_ = {}
