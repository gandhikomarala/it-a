# CalibrationDriftGradientExtractor_Smartportcranes (Automated Container Port STS Cranes)
...
class CalibrationDriftGradientExtractor_Smartportcranes(BaseEstimator, TransformerMixin):
    """CalibrationDriftGradientExtractor_Smartportcranes: Detects progressive sensor bias and calibration offset drift."""
    def __init__(self, prefix: str = "calibration_drift_gradient_smart_port_cranes"):
        self.prefix = prefix
        self.stats_ = {}
