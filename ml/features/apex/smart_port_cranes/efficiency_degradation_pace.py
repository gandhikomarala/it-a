# EfficiencyDegradationPaceExtractor_Smartportcranes (Automated Container Port STS Cranes)
...
class EfficiencyDegradationPaceExtractor_Smartportcranes(BaseEstimator, TransformerMixin):
    """EfficiencyDegradationPaceExtractor_Smartportcranes: Calculates the second-order derivative of thermal and power efficiency."""
    def __init__(self, prefix: str = "efficiency_degradation_pace_smart_port_cranes"):
        self.prefix = prefix
        self.stats_ = {}
