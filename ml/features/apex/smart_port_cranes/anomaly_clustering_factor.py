# AnomalyClusteringFactorExtractor_Smartportcranes (Automated Container Port STS Cranes)
...
class AnomalyClusteringFactorExtractor_Smartportcranes(BaseEstimator, TransformerMixin):
    """AnomalyClusteringFactorExtractor_Smartportcranes: Quantifies temporal clustering of multivariate warning signals."""
    def __init__(self, prefix: str = "anomaly_clustering_factor_smart_port_cranes"):
        self.prefix = prefix
        self.stats_ = {}
