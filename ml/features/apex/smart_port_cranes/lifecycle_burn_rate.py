# LifecycleBurnRateExtractor_Smartportcranes (Automated Container Port STS Cranes)
...
class LifecycleBurnRateExtractor_Smartportcranes(BaseEstimator, TransformerMixin):
    """LifecycleBurnRateExtractor_Smartportcranes: Measures operating hours consumed against rated mean time between failures."""
    def __init__(self, prefix: str = "lifecycle_burn_rate_smart_port_cranes"):
        self.prefix = prefix
        self.stats_ = {}
