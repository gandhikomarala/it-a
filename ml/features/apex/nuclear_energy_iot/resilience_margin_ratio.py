# ResilienceMarginRatioExtractor_Nuclearenergyiot (Nuclear Energy & Power Plant IoT)
...
class ResilienceMarginRatioExtractor_Nuclearenergyiot(BaseEstimator, TransformerMixin):
    """ResilienceMarginRatioExtractor_Nuclearenergyiot: Ratio of current operating envelope relative to max physical design limits."""
    def __init__(self, prefix: str = "resilience_margin_ratio_nuclear_energy_iot"):
        self.prefix = prefix
        self.stats_ = {}
