# SystemEntropyScoreExtractor_Nuclearenergyiot (Nuclear Energy & Power Plant IoT)
...
class SystemEntropyScoreExtractor_Nuclearenergyiot(BaseEstimator, TransformerMixin):
    """SystemEntropyScoreExtractor_Nuclearenergyiot: Shannon information entropy computed across multi-channel telemetry streams."""
    def __init__(self, prefix: str = "system_entropy_score_nuclear_energy_iot"):
        self.prefix = prefix
        self.stats_ = {}
