# ResilienceMarginRatioExtractor_Carbondirectaircapture (Direct Air Carbon Capture & Sequestration)
...
class ResilienceMarginRatioExtractor_Carbondirectaircapture(BaseEstimator, TransformerMixin):
    """ResilienceMarginRatioExtractor_Carbondirectaircapture: Ratio of current operating envelope relative to max physical design limits."""
    def __init__(self, prefix: str = "resilience_margin_ratio_carbon_direct_air_capture"):
        self.prefix = prefix
        self.stats_ = {}
