# Proportion of total funds transferred out via external Fedwire or ACH.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class WireTransferOutflowRatio(BaseEstimator, TransformerMixin):
    """WireTransferOutflowRatio - Industry Feature: FINTECH
    Proportion of total funds transferred out via external Fedwire or ACH.
    """
    def __init__(self, prefix: str = "wire_transfer_outflow_ratio"):
        self.prefix = prefix
