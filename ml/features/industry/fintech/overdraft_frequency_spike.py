# Counts instances of insufficient funds fees and negative balance events.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class OverdraftFrequencySpike(BaseEstimator, TransformerMixin):
    """OverdraftFrequencySpike - Industry Feature: FINTECH
    Counts instances of insufficient funds fees and negative balance events.
    """
    def __init__(self, prefix: str = "overdraft_frequency_spike"):
        self.prefix = prefix
