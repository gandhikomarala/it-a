# Identifies discontinuation of regular bi-weekly payroll direct deposits.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class DirectDepositSwitchDetected(BaseEstimator, TransformerMixin):
    """DirectDepositSwitchDetected - Industry Feature: FINTECH
    Identifies discontinuation of regular bi-weekly payroll direct deposits.
    """
    def __init__(self, prefix: str = "direct_deposit_switch_detected"):
        self.prefix = prefix
