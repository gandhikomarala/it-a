# Monitors delta in revolving credit line utilization percentage.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class CreditUtilizationShift(BaseEstimator, TransformerMixin):
    """CreditUtilizationShift - Industry Feature: FINTECH
    Monitors delta in revolving credit line utilization percentage.
    """
    def __init__(self, prefix: str = "credit_utilization_ratio_shift"):
        self.prefix = prefix
