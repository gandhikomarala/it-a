# Slope of 90-day debit card point-of-sale transaction counts.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class CardTransactionFrequencyTrend(BaseEstimator, TransformerMixin):
    """CardTransactionFrequencyTrend - Industry Feature: FINTECH
    Slope of 90-day debit card point-of-sale transaction counts.
    """
    def __init__(self, prefix: str = "card_transaction_frequency_trend"):
        self.prefix = prefix
