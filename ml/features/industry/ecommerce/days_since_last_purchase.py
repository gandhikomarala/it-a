# Calendar days elapsed since the most recent completed transaction.
...
class DaysSinceLastPurchase(BaseEstimator, TransformerMixin):
    """DaysSinceLastPurchase - Industry Feature: ECOMMERCE
    Calendar days elapsed since the most recent completed transaction.
    """
    def __init__(self, prefix: str = "days_since_last_purchase"):
        self.prefix = prefix
