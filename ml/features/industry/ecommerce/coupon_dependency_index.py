# Proportion of customer lifetime orders containing promotional discount codes.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class CouponDependencyIndex(BaseEstimator, TransformerMixin):
    """CouponDependencyIndex - Industry Feature: ECOMMERCE
    Proportion of customer lifetime orders containing promotional discount codes.
    """
    def __init__(self, prefix: str = "coupon_dependency_index"):
        self.prefix = prefix
