# Counts orders delivered past estimated carrier SLA guarantee dates.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class ShippingDelayExposureCount(BaseEstimator, TransformerMixin):
    """ShippingDelayExposureCount - Industry Feature: ECOMMERCE
    Counts orders delivered past estimated carrier SLA guarantee dates.
    """
    def __init__(self, prefix: str = "shipping_delay_exposure_count"):
        self.prefix = prefix
