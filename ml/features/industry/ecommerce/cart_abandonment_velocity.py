# Ratio of abandoned shopping carts versus completed checkouts over 30 days.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class CartAbandonmentVelocity(BaseEstimator, TransformerMixin):
    """CartAbandonmentVelocity - Industry Feature: ECOMMERCE
    Ratio of abandoned shopping carts versus completed checkouts over 30 days.
    """
    def __init__(self, prefix: str = "cart_abandonment_velocity"):
        self.prefix = prefix
