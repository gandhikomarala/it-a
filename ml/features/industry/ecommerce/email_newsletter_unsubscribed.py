# Flags whether customer opted out of promotional marketing communications.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class NewsletterUnsubscribed(BaseEstimator, TransformerMixin):
    """NewsletterUnsubscribed - Industry Feature: ECOMMERCE
    Flags whether customer opted out of promotional marketing communications.
    """
    def __init__(self, prefix: str = "email_newsletter_unsubscribed"):
        self.prefix = prefix
