# Speed of customer redeeming loyalty reward points without replenishing.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class LoyaltyPointsBurnRate(BaseEstimator, TransformerMixin):
    """LoyaltyPointsBurnRate - Industry Feature: ECOMMERCE
    Speed of customer redeeming loyalty reward points without replenishing.
    """
    def __init__(self, prefix: str = "loyalty_points_burn_rate"):
        self.prefix = prefix
