# NLP sentiment polarity score of verified customer product reviews.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class ProductReviewSentimentScore(BaseEstimator, TransformerMixin):
    """ProductReviewSentimentScore - Industry Feature: ECOMMERCE
    NLP sentiment polarity score of verified customer product reviews.
    """
    def __init__(self, prefix: str = "product_review_sentiment_score"):
        self.prefix = prefix
