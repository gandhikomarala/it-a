# Percentage of purchased orders returned for refunds or store credits.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class ReturnMerchandiseRate(BaseEstimator, TransformerMixin):
    """ReturnMerchandiseRate - Industry Feature: ECOMMERCE
    Percentage of purchased orders returned for refunds or store credits.
    """
    def __init__(self, prefix: str = "return_merchandise_rate"):
        self.prefix = prefix
