# Measures the rate of newly assigned team seats logging in within 14 days.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class SeatActivationVelocity(BaseEstimator, TransformerMixin):
    """SeatActivationVelocity - Industry Feature: B2B_SAAS
    Measures the rate of newly assigned team seats logging in within 14 days.
    """
    def __init__(self, prefix: str = "seat_activation_velocity"):
        self.prefix = prefix
