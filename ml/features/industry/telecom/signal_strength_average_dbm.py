# Average cellular signal strength RSSI/RSRP at primary billing address.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class SignalStrengthAverageDbm(BaseEstimator, TransformerMixin):
    """SignalStrengthAverageDbm - Industry Feature: TELECOM
    Average cellular signal strength RSSI/RSRP at primary billing address.
    """
    def __init__(self, prefix: str = "signal_strength_average_dbm"):
        self.prefix = prefix
