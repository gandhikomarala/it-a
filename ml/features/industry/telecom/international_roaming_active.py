# Flags usage of roaming data packages indicating frequent business travelers.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class InternationalRoamingActive(BaseEstimator, TransformerMixin):
    """InternationalRoamingActive - Industry Feature: TELECOM
    Flags usage of roaming data packages indicating frequent business travelers.
    """
    def __init__(self, prefix: str = "international_roaming_active"):
        self.prefix = prefix
