# CoreAMFAuthLatencyExtractor (Telecom 5G Network Slicing)
# Authentication and Mobility Management Function registration latency.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class CoreAMFAuthLatencyExtractor(BaseEstimator, TransformerMixin):
    """CoreAMFAuthLatencyExtractor: Authentication and Mobility Management Function registration latency."""
    def __init__(self, prefix: str = "core_amf_authentication_latency"):
        self.prefix = prefix
        self.stats_ = {}
