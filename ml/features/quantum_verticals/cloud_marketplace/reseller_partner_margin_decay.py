# ResellerMarginDecayExtractor (B2B Cloud Marketplace SaaS)
# Tracks compression in channel partner reseller margins.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class ResellerMarginDecayExtractor(BaseEstimator, TransformerMixin):
    """ResellerMarginDecayExtractor: Tracks compression in channel partner reseller margins."""
    def __init__(self, prefix: str = "reseller_partner_margin_decay"):
        self.prefix = prefix
        self.stats_ = {}
