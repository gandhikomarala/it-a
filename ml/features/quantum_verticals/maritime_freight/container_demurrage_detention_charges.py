# DemurrageChargesExtractor (Maritime Shipping & Ocean Freight)
# Accumulated port container demurrage and detention penalty fees.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class DemurrageChargesExtractor(BaseEstimator, TransformerMixin):
    """DemurrageChargesExtractor: Accumulated port container demurrage and detention penalty fees."""
    def __init__(self, prefix: str = "container_demurrage_detention_charges"):
        self.prefix = prefix
        self.stats_ = {}
