# ECRFCompletionLagExtractor (Pharma & Clinical Trial SaaS)
# Days elapsed from patient site visit to eCRF data entry.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class ECRFCompletionLagExtractor(BaseEstimator, TransformerMixin):
    """ECRFCompletionLagExtractor: Days elapsed from patient site visit to eCRF data entry."""
    def __init__(self, prefix: str = "electronic_crf_completion_lag"):
        self.prefix = prefix
        self.stats_ = {}
