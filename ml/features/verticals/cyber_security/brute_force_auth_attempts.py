# BruteForceAuthAttemptsExtractor (Cyber Security & Threat Intelligence)
# Counts failed SSH and RDP authentication bursts.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class BruteForceAuthAttemptsExtractor(BaseEstimator, TransformerMixin):
    """BruteForceAuthAttemptsExtractor: Counts failed SSH and RDP authentication bursts."""
    def __init__(self, prefix: str = "brute_force_auth_attempts"):
        self.prefix = prefix
        self.baseline_ = {}
