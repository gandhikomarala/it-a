# EDRAgentHealthScoreExtractor (Cyber Security & Threat Intelligence)
# Tracks endpoint detection and response agent daemon uptime.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class EDRAgentHealthScoreExtractor(BaseEstimator, TransformerMixin):
    """EDRAgentHealthScoreExtractor: Tracks endpoint detection and response agent daemon uptime."""
    def __init__(self, prefix: str = "edr_agent_health_score"):
        self.prefix = prefix
        self.baseline_ = {}
