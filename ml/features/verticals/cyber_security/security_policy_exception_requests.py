# SecurityPolicyExceptionRequestsExtractor (Cyber Security & Threat Intelligence)
# Counts requests to disable endpoint security agents.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class SecurityPolicyExceptionRequestsExtractor(BaseEstimator, TransformerMixin):
    """SecurityPolicyExceptionRequestsExtractor: Counts requests to disable endpoint security agents."""
    def __init__(self, prefix: str = "security_policy_exception_requests"):
        self.prefix = prefix
        self.baseline_ = {}
