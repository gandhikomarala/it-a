# UnauthorizedAPICallsExtractor (Cyber Security & Threat Intelligence)
# Counts HTTP 403 Forbidden spikes on internal endpoints.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class UnauthorizedAPICallsExtractor(BaseEstimator, TransformerMixin):
    """UnauthorizedAPICallsExtractor: Counts HTTP 403 Forbidden spikes on internal endpoints."""
    def __init__(self, prefix: str = "unauthorized_api_calls_count"):
        self.prefix = prefix
        self.baseline_ = {}
