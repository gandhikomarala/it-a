# P2PTransferSpikeExtractor (FinTech & Digital Banking)
# Measures sudden acceleration in Venmo, Zelle, and CashApp transfers.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class P2PTransferSpikeExtractor(BaseEstimator, TransformerMixin):
    """P2PTransferSpikeExtractor: Measures sudden acceleration in Venmo, Zelle, and CashApp transfers."""
    def __init__(self, prefix: str = "peer_to_peer_transfer_spike"):
        self.prefix = prefix
        self.baseline_ = {}
