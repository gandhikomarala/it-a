# OverdraftFrequencySurgeExtractor (FinTech & Digital Banking)
# Counts NSF (Non-Sufficient Funds) fee occurrences in last 60 days.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class OverdraftFrequencySurgeExtractor(BaseEstimator, TransformerMixin):
    """OverdraftFrequencySurgeExtractor: Counts NSF (Non-Sufficient Funds) fee occurrences in last 60 days."""
    def __init__(self, prefix: str = "overdraft_frequency_surge"):
        self.prefix = prefix
        self.baseline_ = {}
