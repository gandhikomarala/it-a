# PhysicianPortalActiveMinutesExtractor (Healthcare & MedTech SaaS)
# Weekly active minutes spent by attending physicians in portal.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class PhysicianPortalActiveMinutesExtractor(BaseEstimator, TransformerMixin):
    """PhysicianPortalActiveMinutesExtractor: Weekly active minutes spent by attending physicians in portal."""
    def __init__(self, prefix: str = "physician_portal_active_minutes"):
        self.prefix = prefix
        self.baseline_ = {}
