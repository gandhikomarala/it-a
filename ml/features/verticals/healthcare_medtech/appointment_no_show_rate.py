# AppointmentNoShowRateExtractor (Healthcare & MedTech SaaS)
# Percentage of scheduled appointments marked as patient no-show.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class AppointmentNoShowRateExtractor(BaseEstimator, TransformerMixin):
    """AppointmentNoShowRateExtractor: Percentage of scheduled appointments marked as patient no-show."""
    def __init__(self, prefix: str = "appointment_no_show_rate"):
        self.prefix = prefix
        self.baseline_ = {}
