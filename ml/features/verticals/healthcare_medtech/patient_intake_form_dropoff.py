# PatientIntakeFormDropoffExtractor (Healthcare & MedTech SaaS)
# Percentage of digital intake questionnaires abandoned before submission.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class PatientIntakeFormDropoffExtractor(BaseEstimator, TransformerMixin):
    """PatientIntakeFormDropoffExtractor: Percentage of digital intake questionnaires abandoned before submission."""
    def __init__(self, prefix: str = "patient_intake_form_dropoff"):
        self.prefix = prefix
        self.baseline_ = {}
