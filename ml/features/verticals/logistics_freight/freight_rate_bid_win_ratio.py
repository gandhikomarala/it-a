# FreightRateBidWinRatioExtractor (Logistics & Supply Chain SaaS)
# Ratio of spot market spot bids won by logistics broker.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class FreightRateBidWinRatioExtractor(BaseEstimator, TransformerMixin):
    """FreightRateBidWinRatioExtractor: Ratio of spot market spot bids won by logistics broker."""
    def __init__(self, prefix: str = "freight_rate_bid_win_ratio"):
        self.prefix = prefix
        self.baseline_ = {}
