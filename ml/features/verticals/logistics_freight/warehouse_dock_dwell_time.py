# WarehouseDockDwellTimeExtractor (Logistics & Supply Chain SaaS)
# Average hours trucks spend waiting at loading dock bays.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class WarehouseDockDwellTimeExtractor(BaseEstimator, TransformerMixin):
    """WarehouseDockDwellTimeExtractor: Average hours trucks spend waiting at loading dock bays."""
    def __init__(self, prefix: str = "warehouse_dock_dwell_time"):
        self.prefix = prefix
        self.baseline_ = {}
