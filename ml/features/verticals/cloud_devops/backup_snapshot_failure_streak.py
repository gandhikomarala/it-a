# BackupSnapshotFailureStreakExtractor (Cloud Infrastructure & DevOps)
# Tracks consecutive failures of scheduled EBS/GCS snapshot jobs.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class BackupSnapshotFailureStreakExtractor(BaseEstimator, TransformerMixin):
    """BackupSnapshotFailureStreakExtractor: Tracks consecutive failures of scheduled EBS/GCS snapshot jobs."""
    def __init__(self, prefix: str = "backup_snapshot_failure_streak"):
        self.prefix = prefix
        self.baseline_ = {}
