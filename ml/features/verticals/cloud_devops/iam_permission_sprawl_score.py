# IAMPermissionSprawlScoreExtractor (Cloud Infrastructure & DevOps)
# Quantifies unattached IAM policies and over-privileged admin roles.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class IAMPermissionSprawlScoreExtractor(BaseEstimator, TransformerMixin):
    """IAMPermissionSprawlScoreExtractor: Quantifies unattached IAM policies and over-privileged admin roles."""
    def __init__(self, prefix: str = "iam_permission_sprawl_score"):
        self.prefix = prefix
        self.baseline_ = {}
