# SpotInstancePreemptionRateExtractor (Cloud Infrastructure & DevOps)
# Calculates cluster disruption frequency from spot instance reclamations.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class SpotInstancePreemptionRateExtractor(BaseEstimator, TransformerMixin):
    """SpotInstancePreemptionRateExtractor: Calculates cluster disruption frequency from spot instance reclamations."""
    def __init__(self, prefix: str = "spot_instance_preemption_rate"):
        self.prefix = prefix
        self.baseline_ = {}
