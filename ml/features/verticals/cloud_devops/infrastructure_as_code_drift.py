# IaCDriftExtractor (Cloud Infrastructure & DevOps)
# Measures unmanaged AWS/GCP resources created outside Terraform.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class IaCDriftExtractor(BaseEstimator, TransformerMixin):
    """IaCDriftExtractor: Measures unmanaged AWS/GCP resources created outside Terraform."""
    def __init__(self, prefix: str = "infrastructure_as_code_drift"):
        self.prefix = prefix
        self.baseline_ = {}
