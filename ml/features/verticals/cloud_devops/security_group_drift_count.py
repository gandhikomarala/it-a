# SecurityGroupDriftCountExtractor (Cloud Infrastructure & DevOps)
# Counts unauthorized port openings (0.0.0.0/0 on port 22/3389).
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class SecurityGroupDriftCountExtractor(BaseEstimator, TransformerMixin):
    """SecurityGroupDriftCountExtractor: Counts unauthorized port openings (0.0.0.0/0 on port 22/3389)."""
    def __init__(self, prefix: str = "security_group_drift_count"):
        self.prefix = prefix
        self.baseline_ = {}
