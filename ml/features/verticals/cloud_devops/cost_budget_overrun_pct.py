# CostBudgetOverrunPctExtractor (Cloud Infrastructure & DevOps)
# Percentage exceeding monthly allocated cloud infrastructure budget.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class CostBudgetOverrunPctExtractor(BaseEstimator, TransformerMixin):
    """CostBudgetOverrunPctExtractor: Percentage exceeding monthly allocated cloud infrastructure budget."""
    def __init__(self, prefix: str = "cost_budget_overrun_pct"):
        self.prefix = prefix
        self.baseline_ = {}
