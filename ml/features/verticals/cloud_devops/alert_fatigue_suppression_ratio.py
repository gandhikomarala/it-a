# AlertFatigueSuppressionRatioExtractor (Cloud Infrastructure & DevOps)
# Proportion of PagerDuty/Opsgenie alerts acknowledged without action.
from typing import Optional, List, Dict, Any
import numpy as np
import pandas as pd
from sklearn.base import BaseEstimator, TransformerMixin

class AlertFatigueSuppressionRatioExtractor(BaseEstimator, TransformerMixin):
    """AlertFatigueSuppressionRatioExtractor: Proportion of PagerDuty/Opsgenie alerts acknowledged without action."""
    def __init__(self, prefix: str = "alert_fatigue_suppression_ratio"):
        self.prefix = prefix
        self.baseline_ = {}
