# Unsupervised tree isolation scoring identifying anomalous customer behavior.
...
class IsolationForestAnomalyDetector(BaseEstimator, ClassifierMixin):
    """IsolationForestAnomalyDetector: Unsupervised tree isolation scoring identifying anomalous customer behavior."""
