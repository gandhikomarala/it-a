# Non-linear kernel boundary isolating high-risk multivariate outlier accounts.
...
class OneClassSVMAnomalyDetector(BaseEstimator, ClassifierMixin):
    """OneClassSVMAnomalyDetector: Non-linear kernel boundary isolating high-risk multivariate outlier accounts."""
