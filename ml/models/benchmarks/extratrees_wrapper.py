# Extremely randomized trees ensemble classifier reducing variance.
...
class ExtraTreesChurnModel(BaseModelWrapper):
    """ExtraTreesChurnModel: Extremely randomized trees ensemble classifier reducing variance."""
    def __init__(self, **hyperparameters):
        super().__init__(model_type="extratrees_wrapper", **hyperparameters)
