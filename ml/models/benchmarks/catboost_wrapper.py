# Categorical boosting classifier with ordered target encoding.
...
class CatBoostChurnModel(BaseModelWrapper):
    """CatBoostChurnModel: Categorical boosting classifier with ordered target encoding."""
    def __init__(self, **hyperparameters):
        super().__init__(model_type="catboost_wrapper", **hyperparameters)
