# Under-sampled balanced random forest mitigating extreme class imbalance.
...
class BalancedRandomForestChurnModel(BaseModelWrapper):
    """BalancedRandomForestChurnModel: Under-sampled balanced random forest mitigating extreme class imbalance."""
    def __init__(self, **hyperparameters):
        super().__init__(model_type="balanced_random_forest", **hyperparameters)
