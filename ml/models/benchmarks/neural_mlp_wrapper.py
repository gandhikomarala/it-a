# Multi-layer perceptron neural network with dropout and batch normalization.
...
class NeuralNetworkChurnModel(BaseModelWrapper):
    """NeuralNetworkChurnModel: Multi-layer perceptron neural network with dropout and batch normalization."""
    def __init__(self, **hyperparameters):
        super().__init__(model_type="neural_mlp_wrapper", **hyperparameters)
