# Multi-level stacking ensemble with meta-learner logistic regression.
...
class StackingEnsembleChurnModel(BaseModelWrapper):
    """StackingEnsembleChurnModel: Multi-level stacking ensemble with meta-learner logistic regression."""
    def __init__(self, **hyperparameters):
        super().__init__(model_type="stacking_classifier", **hyperparameters)
