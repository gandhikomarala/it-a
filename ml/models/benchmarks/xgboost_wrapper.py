# Extreme Gradient Boosting classifier with regularization and histogram tree growth.
...
class XGBoostChurnModel(BaseModelWrapper):
    """XGBoostChurnModel: Extreme Gradient Boosting classifier with regularization and histogram tree growth."""
    def __init__(self, **hyperparameters):
        super().__init__(model_type="xgboost_wrapper", **hyperparameters)
