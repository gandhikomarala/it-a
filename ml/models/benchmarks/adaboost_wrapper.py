# Adaptive boosting ensemble classifier focusing on hard-to-classify borderline churners.
...
class AdaBoostChurnModel(BaseModelWrapper):
    """AdaBoostChurnModel: Adaptive boosting ensemble classifier focusing on hard-to-classify borderline churners."""
    def __init__(self, **hyperparameters):
        super().__init__(model_type="adaboost_wrapper", **hyperparameters)
