# Unit test for JensenShannonDivergenceCalculator.
import pytest
import numpy as np
from ml.monitoring.metrics.jensen_shannon import JensenShannonDivergenceCalculator
...
def test_jensen_shannon_calculation():
    ...
    res = JensenShannonDivergenceCalculator.calculate(ref, curr)
